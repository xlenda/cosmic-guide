...
const TELA = {
  ...
  // Acrescentado quando a feature entrou DENTRO do Álbum das 78: a tela não
  // redige uma linha, então tudo o que ela precisa dizer nasce aqui e tem par
  // exato em .es e .en. Os dois rótulos de número embaixo servem à DISTÂNCIA,
  // que é o conteúdo da feature — o número vem calculado do motor, o rótulo
  // vem daqui.
  abrir: 'Toque para abrir',
  fechar: 'Toque para fechar',
  fecharLinhaDoTempo: 'Fechar a linha do tempo',
  rotuloSeculosDeImagem: 'séculos de imagem',
  rotuloAnosDeLeitura: 'anos de leitura de cartas',
  rotuloEstaSecao: 'A história desta seção',
  rotuloEstaCarta: 'A história desta carta',
  seloHistoria: 'Esta carta tem nota de história',
  compartilhar: 'Compartilhar',
  copiado: 'Copiado. Cole onde quiser.',
  naoCopiou: 'Aqui não deu para copiar. Selecione o texto acima e copie à mão.',
