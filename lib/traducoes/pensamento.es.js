...
export default {
  ...
  //
  // LA FORMA DE LAS TRES, desde el 04/08/2026: GOLPE CORTO Y DESPUÉS EL
  // DESARROLLO — igual que el PT. Es la primera línea que la persona lee en la
  // app: si no agarra, el resto del pensamiento no se lee. Y la regla no se
  // aflojó: invitación y espejo, nunca promesa. Ninguna de las tres dice lo que
  // VA a pasar.
  aberturas: {
    manha:
      'Nadie escribió nada en este día todavía. Llega entero, y lo primero que entra en él es lo que decidas mirar primero.',
    tarde:
      'La mitad de tu día ya se fue. La pregunta honesta es si va para el lado que querías — y todavía queda la otra mitad para responder.',
    noite:
      'El día está cerrando la puerta. Antes de acostarte, vale mirar atrás y escribir una línea sobre lo que te dejó — lo que nadie anota suele desaparecer.',
  },
  ...
  //
  // LAS TRES PIEZAS DEL RECIBO (04/08/2026). La ficha técnica dejó de abrir el
  // texto y pasó a cerrarlo: `recibo` es el rótulo que anuncia la procedencia,
  // `luaEm` es la coordenada y `assinatura` es a quién está dirigida la
  // lectura. Nada se perdió — la fase, el signo lunar y el signo de la persona
  // siguen todos ahí, al final, como recibo de lo que se acaba de leer.
  recibo: 'De dónde sale lo que acabas de leer: ',
  luaEm: 'La Luna está en {signo} {emoji}. ',
  assinatura: 'Lectura de hoy para {icone}{signo}.',
