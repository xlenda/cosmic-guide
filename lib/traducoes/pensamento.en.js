...
export default {
  ...
  //
  // THE SHAPE OF ALL THREE, since 04/08/2026: SHORT PUNCH FIRST, THEN THE
  // UNFOLDING — same as the PT. This is the first line anyone reads in the
  // app: if it doesn't hold, the rest of the thought never gets read. The rule
  // did not loosen along with it — invitation and mirror, never a promise.
  // None of the three says what WILL happen.
  aberturas: {
    manha:
      'Nobody has written anything on this day yet. It arrives whole, and the first thing to land in it is whatever you choose to look at first.',
    tarde:
      'Half your day is already gone. The honest question is whether it\'s going where you wanted it to — and there\'s a whole other half left to answer that.',
    noite:
      'The day is closing its door. Before bed, worth looking back and writing one line about what it left you — what nobody writes down tends to disappear.',
  },
  ...
  //
  // THE THREE PIECES OF THE RECEIPT (04/08/2026). The spec sheet stopped
  // opening the text and now closes it: `recibo` is the label that announces
  // where the reading comes from, `luaEm` is the coordinate, and `assinatura`
  // says who the reading is addressed to. Nothing was lost — phase, Moon sign
  // and the reader's own sign are all still in the text, at the end, as a
  // receipt for what was just read.
  recibo: 'Where what you just read comes from: ',
  luaEm: 'The Moon is in {signo} {emoji}. ',
  assinatura: 'Today\'s reading for {icone}{signo}.',
