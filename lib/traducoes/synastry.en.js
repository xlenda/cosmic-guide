...
// The label of the path's ECHO — the whole doctrine lives in the PT pack.
// It is deliberately the same phrase every `caminho` in this pack opens with
// ("Where to start, in practice:"): the echo trims that opening off the body so
// the same words are not said twice in the same fold of the screen.
const ROTULO_CAMINHO = 'Where to start';
