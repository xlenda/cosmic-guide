...
// a paridade é cobrada por test/decanatoPorque.test.js.
//
...
// • Linha vermelha (test/copy-promessa-app-inteiro.test.js): aliviar/calmar/sanar/curar/
...
const pack = {
  ...
  frames: {
    ...
    invertidaSituacao: 'Situación, {nome} invertida: {eixoNome} está trabado. {significado} En {nome} invertida, {contexto} quedan bajo bloqueo.',
    invertidaTensao: 'Tensión en {nome} invertida: {eixoNome} está trabado. {significado}',
    invertidaProximoPasso: 'Próximo paso, {nome} invertida: {eixoNome} sigue trabado. {significado}. Vector, no hecho consumado.',
    ...
    diretaSituacao: 'Situación, {nome}: {significado}. En {nome}, {contexto} delimitan el cuadro.',
    diretaTensao: 'Tensión en {nome}: {significado}. Sombra: {sombra}.',
    diretaProximoPasso: 'Próximo paso, {nome}: {significado}. Vector, no hecho consumado.',
    ...
    maiorTensao: '{opener}: {nome}; letra {letra}, bajo {atributo}; Golden Dawn.',
    maiorProximoPasso: '{opener}: {nome}; arcano {numero}, Árbol de la Vida, camino {caminho}; Golden Dawn.',
    ...
    asTensao: '{campo} {nome}: {astro}; potencial bajo fricción; Golden Dawn.',
    asProximoPasso: '{campo} {nome}: {astro}; semilla en acción; Golden Dawn.',
    ...
    corteTensao: '{campo} {nome}: fricción en {astro}; {papel}; Golden Dawn.',
    corteProximoPasso: '{campo} {nome}: gesto en {astro}; {papel}; Golden Dawn.',
    ...
    numeradaTensao: '{campo} {nome}: {tituloGD} bajo fricción; {astro}; {papel}; Golden Dawn.',
