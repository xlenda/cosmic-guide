...
// ---------------------------------------------------------------------------
// O CHROME DA VITRINE — screens/ComoDecideScreen.js
// ---------------------------------------------------------------------------
// Rótulo de botão, cabeçalho de seção e recado de cópia. Nasceram AQUI, e não
// em lib/i18n.js, pela mesma regra do resto do módulo: a tela é vitrine, não
// redige uma linha e não escolhe idioma — ela lê `cardComoDecide(lang).idioma`,
// que é o idioma que o MOTOR já resolveu, e pega este bloco no pack
// correspondente. Se um dia o motor exportar um `chromeDaTela(lang)`, a tela
// troca a leitura por ele sem que uma vírgula daqui mude.
//
// `textoCompartilhavel` mora no pack pelo mesmo motivo: o texto que viaja no
// WhatsApp de quem recebe é conteúdo, e conteúdo não nasce dentro de
// componente. Ele fecha SEMPRE no link, como em lib/idadeReal.js.
const MARCA = 'cosmicguide.cloud';

const CHROME = {
  subtitulo: 'O que é conta, o que é leitura, e o que o app não faz',
  ondeAparece: 'ONDE ISSO APARECE',
  abrir: 'Ver como esta parte é decidida',
  fechar: 'Fechar',
  pendencia: 'SEM FONTE DE PRIMEIRA MÃO',
  verbatim: 'NAS PALAVRAS DA FONTE',
  compartilhar: 'Compartilhar',
  copiado: 'Texto copiado — cola onde quiser.',
  naoCopiou: 'Não deu pra copiar aqui — seleciona o texto e copia.',
  bibliografiaNota:
    'Cada obra entra uma vez só, na ordem em que o app a usa. O que ainda não tem edição de primeira mão lida fica de fora desta lista e aparece escrito dentro do próprio item.',
  rodape:
    'Se você achar nesta tela uma afirmação sem obra, autor e século, o erro é nosso — e vale escrever pra gente.',
  marca: MARCA,
