...
export default {
  ...
  mitos: {
    ...
    'quiromancia-milenar': {
      ...
      detalhe:
        "La línea del matrimonio que te mostraron en la playa tiene menos edad que la fotografía. El paquete completo — montes, tipos de mano, líneas con nombre — se armó entre 1843 y 1900, de D'Arpentigny a Benham. Y los cuatro tipos de mano por elemento son de 1965, de Fred Gettings.",
    },
    'borra-de-cafe': {
      oQueTeContaram: 'Leer la borra del café es una tradición turca milenaria, con símbolos ancestrales.',
      oQueAFonteDiz:
        'El café recién llega a Estambul en el siglo XVI — la práctica no puede ser más vieja que la bebida. Y el diccionario de símbolos (serpiente = enemistad, casa = mudanza) es salón británico de fines del siglo XIX, consolidado por Cicely Kent en 1922.',
    ...
    'mercurio-retrogrado': {
      ...
      detalhe:
        'El culpable oficial de la laptop trabada tiene coartada de casi dos mil años. Lo que Valente escribió en el siglo II fue demora: el retrógrado "pospone expectativas, acciones y ganancias" — nada de aparatos, contratos ni ex. La expresión recién llega a la prensa a partir de 1996.',
    },
    'leao-coracao': {
      ...
      detalhe:
        'Pregunta en una rueda de astrología de dónde viene el "Leo rige el corazón" y nadie señala el libro. En la lista más antigua de cuerpo y signo, Manilio le da a Leo los flancos y los omóplatos — el corazón pertenecía al Sol. La versión popular recién aparece impresa en 1533, en la Escala del Doce de Agrippa.',
    },
    ofiuco: {
    ...
    'urano-aquario': {
      ...
      detalhe:
        'El "regente clásico" de Acuario ni siquiera existía en los mapas hasta hace nada: Urano recién fue descubierto en 1781. En la tradición, Acuario siempre fue casa de Saturno. El cambio empieza alrededor de 1825 — y en 1834 todavía había lectores de almanaque preguntando por qué el planeta nuevo no tenía casa.',
    },
    'estrela-esperanca': {
    ...
    'cruz-celta': {
      ...
      fonte: 'A. E. Waite, The Pictorial Key to the Tarot, 1911',
      detalhe:
        'La tirada más famosa del tarot no tiene nada de druida. El nombre "Cruz Celta" estrena en 1911, en el manual de Waite, y el diseño viene de los círculos ocultistas de Londres de los años 1890. De celta, solo el bautizo.',
    },
    ...
    'horoscopo-de-jornal': {
      ...
      detalhe:
        'El horóscopo de tu feed tiene fecha de estreno como una telenovela: agosto de 1930, en un diario británico, sobre el nacimiento de una princesa. Era tanta la novedad que el diario tuvo que explicarles a los lectores qué era un horóscopo. En la tradición, quien describe al individuo es el Ascendente, no el signo solar.',
    },
    'signo-personalidade': {
