...
// ---------------------------------------------------------------------------
// EL CHROME DE LA VITRINA — screens/ComoDecideScreen.js
// ---------------------------------------------------------------------------
// Misma forma y mismas claves que el pack portugués: rótulo de botón, encabezado
// de sección y aviso de copiado. Viven ACÁ, y no en lib/i18n.js, porque la
// pantalla es vitrina: no redacta ni elige idioma — lee
// `cardComoDecide(lang).idioma`, que es el idioma que ya resolvió el motor.
//
// `textoCompartilhavel` vive en el pack por el mismo motivo: el texto que viaja
// por WhatsApp es contenido, y el contenido no nace adentro de un componente.
// Cierra SIEMPRE en el link, como en lib/idadeReal.js.
const MARCA = 'cosmicguide.cloud';

const CHROME = {
  subtitulo: 'Qué es cuenta, qué es lectura y qué se niega a hacer la app',
  ondeAparece: 'DÓNDE APARECE',
  abrir: 'Ver cómo se decide esta parte',
  fechar: 'Cerrar',
  pendencia: 'SIN FUENTE DE PRIMERA MANO',
  verbatim: 'EN PALABRAS DE LA FUENTE',
  compartilhar: 'Compartir',
  copiado: 'Texto copiado — pegalo donde quieras.',
  naoCopiou: 'No se pudo copiar acá — seleccioná el texto y copialo.',
  bibliografiaNota:
    'Cada obra entra una sola vez, en el orden en que la app la usa. Lo que todavía no tiene edición de primera mano leída queda afuera de esta lista y aparece escrito adentro del propio ítem.',
  rodape:
    'Si encontrás en esta pantalla una afirmación sin obra, autor y siglo, el error es nuestro — y vale escribirnos.',
  marca: MARCA,
