...
// ---------------------------------------------------------------------------
// O CHROME DA TELA — títulos e rótulos de quem MOSTRA esta leitura
// ---------------------------------------------------------------------------
// Nasceu quando a feature entrou no modal do Álbum das 78. A tela não redige
// uma linha: tudo o que ela precisa escrever mora aqui, com paridade exata de
// chaves em .es e .en. Nenhum destes rótulos diz o que a carta significa —
// eles só nomeiam as caixas em que a REGRA aparece.
const CHROME = {
  titulo: 'Por que esta carta é este decanato',
  subtitulo: 'A regra que decidiu isso antes de o baralho chegar na sua mão',
  abrir: 'Toque para ver a regra',
  fechar: 'Toque para fechar a regra',
  rotuloTituloGD: 'Nome tradicional',
  rotuloRegra: 'A regra, em quatro passos',
  rotuloConta: 'A conta desta carta',
  rotuloConferencia: 'Conferido agora',
  rotuloCamadas: 'As três idades disto',
  rotuloCitacoes: 'No original',
  rotuloRessalvas: 'O que anda junto com esta leitura',
