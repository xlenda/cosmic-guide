...
const TELA = {
  ...
  // Añadido cuando la sección entró DENTRO del Álbum de las 78: la pantalla no
  // redacta ni una línea, así que todo lo que necesita decir nace aquí, con
  // paridad exacta de claves con .pt y .en. Las dos etiquetas numéricas sirven
  // a la DISTANCIA, que es el contenido de esta sección: el número lo calcula
  // el motor, la etiqueta viene de aquí.
  abrir: 'Toca para abrir',
  fechar: 'Toca para cerrar',
  fecharLinhaDoTempo: 'Cerrar la línea del tiempo',
  rotuloSeculosDeImagem: 'siglos de imagen',
  rotuloAnosDeLeitura: 'años de lectura de cartas',
  rotuloEstaSecao: 'La historia de esta sección',
  rotuloEstaCarta: 'La historia de esta carta',
  seloHistoria: 'Esta carta tiene nota de historia',
  compartilhar: 'Compartir',
  copiado: 'Copiado. Pégalo donde quieras.',
  naoCopiou: 'Aquí no se pudo copiar. Selecciona el texto de arriba y cópialo a mano.',
