...
// ---------------------------------------------------------------------------
// EL CHROME DE LA PANTALLA — solo rótulos, y nada más que rótulos
// ---------------------------------------------------------------------------
// La vitrina (el bloque de las dos listas dentro de screens/ZodiacBodyScreen.js)
// no redacta ni una línea: pasa el `lang` e imprime lo que está aquí. Ninguna
// cadena de este bloque hace una afirmación histórica nueva — toda afirmación
// sigue saliendo del motor con obra, autor y siglo pegados.
//
// Los tres packs tienen este bloque con las MISMAS claves.
const CHROME = {
  selo: 'Dos listas, no una',
  secao: 'Las dos listas del cuerpo, una al lado de la otra',
  abrir: 'abrir',
  fechar: 'cerrar',
  etiquetaApp:
    'La comparación de abajo es lectura de la app sobre las dos listas — ninguna de las dos fuentes habla de la otra.',
  rotuloSeuSigno: 'La línea de tu signo solar',
  rotuloTabela: 'Las doce líneas, una al lado de la otra',
  ajudaTabela: 'Toca un signo para ver las dos columnas enteras y el recibo de cada una.',
  rotuloConta: 'El recuento, línea por línea',
  rotuloComoSurgiram: 'De dónde salieron las dos listas',
  rotuloNatureza: 'Naturaleza de la parte',
  rotuloRecibo: 'Recibo',
  rotuloRessalvas: 'Las salvedades de esta pantalla',
  rotuloBloqueio: 'Lo que esta pantalla todavía no cotejó',
  rotuloFontes: 'De dónde vino cada línea',
  confianca: { alta: 'confianza alta', media: 'confianza media' },
  signoDeclarado:
    'Esta línea vino del signo que está en tu perfil. Con la fecha de nacimiento, la app lee el signo por la posición real del Sol en vez de aceptar lo declarado.',
  irParaMapa: 'Abrir la Carta Astral',
  compartilhar: 'Compartir',
  copiado: 'Texto copiado. Solo queda pegarlo donde quieras.',
  naoCopiou: 'Aquí no se pudo copiar. Selecciona el texto y cópialo a mano.',
  marca: 'Cosmic Guide',
  indisponivel:
    'La comparación de las dos listas no se pudo armar ahora. La app prefiere no mostrar nada antes que mostrar media línea.',
};
