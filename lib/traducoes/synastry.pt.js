...
//
// ===========================================================================
// O RÓTULO DO ECO — o caminho estava certo e no lugar errado (04/08/2026, tarde)
// ===========================================================================
// O campo `caminho` nasceu colado na Atenção, que mora no BLOCO 2 — e o bloco 2
// nasce RECOLHIDO em toda leitura nova. Resultado: quem não toca em "De onde vem
// isso" fecha a tela com o diagnóstico inteiro e nenhuma saída. O pedido de
// 04/08 tinha sido atendido pela metade: a saída existia, escrita e testada nos
// três idiomas, e não chegava aos olhos de quem não abre bibliografia.
//
// A correção é um ECO, e eco não é mudança de lugar: o bloco 1 mostra a PRIMEIRA
// frase do caminho — que é onde mora o gesto — sob este rótulo, e o toque abre o
// bloco 2 no caminho inteiro. Nenhum byte do caminho muda; ele continua sendo o
// texto completo, com a citação de Lilly e o locus, lá embaixo.
//
// O rótulo vive AQUI, e não em lib/i18n.js, pelo mesmo motivo do resto da
// leitura: chave de dicionário pra texto que só a sinastria usa espalha a
// sinastria por dois arquivos, e foi assim que o app já saiu em português pra
// quem lia em inglês.
//
// E ele é DE PROPÓSITO a mesma frase com que todo caminho abre ("Por onde
// começar, na prática:"): é exatamente essa abertura que o eco corta do corpo,
// pra não dizer a mesma coisa duas vezes na mesma dobra da tela. Quem mudar o
// rótulo sem mudar a abertura dos caminhos vai ver o eco parar de cortar — e o
// teste do eco em test/synastryIdiomas.test.js quebra antes de alguém publicar.
const ROTULO_CAMINHO = 'Por onde começar';
