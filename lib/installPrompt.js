...
export async function promptInstall() {
  ...
  deferredEvent = null;
  // beforeinstallprompt só dispara uma vez por evento — depois de consumido
  // (aceito OU dispensado), o botão "Instalar" precisa saber que não há mais
  // prompt disponível, senão fica achando que ainda pode instalar e o próximo
  // toque não faz nada (achado real de auditoria, 25/07/2026).
  listeners.forEach((cb) => cb(false));
