...
// Exportados (08/08/2026) pra lib/tarotNovidade.js — a bolinha de novidade da
// aba Tarô no dock (App.js) — ler o MESMO registro que recordDraw grava, sem
// duplicar nem o prefixo da chave nem o formato da data em outro arquivo.
...
function storageKey(themeKey) {
  return `${DAILY_KEY_PREFIX}${themeKey}`;
}
