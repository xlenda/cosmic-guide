...
// ---------------------------------------------------------------------------
// Catálogo. Campos com os MESMOS nomes de REWARDS da Loja (title/description/
// cost/icon/webOnly) pra render idêntico, mais:
...
export const BRINDES = [
  {
    ...
    kind: 'conteudo',
    title: 'Guia do Ritual de Lua Cheia',
    description: 'Ritual guiado em 4 passos pra próxima Lua Cheia — seu pra sempre, reabre quando quiser.',
    cost: 35,
    icon: 'moon',
  },
  {
    ...
    kind: 'conteudo',
    title: 'Pack de Wallpapers Místicos',
    description: '3 fundos de tela exclusivos (1080×1920) pra baixar na hora.',
    cost: 40,
    icon: 'image',
  ...
  },
  {
    ...
    kind: 'conteudo',
    title: 'Tiragem da Lua Interior',
    description: 'Tiragem exclusiva de 3 posições + 1 Leitura Bônus de Tarô já creditada pra você usar nela.',
    cost: 70,
    icon: 'sparkles',
  ...
  // ---- FÍSICOS (estrutura pronta, DESLIGADA — ver BRINDES_FISICOS_ATIVOS) --
  {
    ...
    kind: 'fisico',
    fisico: true,
    title: 'Incenso Místico (kit 7 varetas)',
    description: 'Kit de incensos naturais enviado pra sua casa — em breve.',
    cost: 400,
    icon: 'flame',
  },
  {
    ...
    kind: 'fisico',
    fisico: true,
    title: 'Cristal de Quartzo',
    description: 'Quartzo natural escolhido a dedo, enviado pra sua casa — em breve.',
    cost: 600,
    icon: 'diamond',
  },
];
