...
const PLAY_STORE_I18N = {
  pt: {
    ...
    'report.body': 'Esta resposta foi gerada por IA. Escolha o motivo e a resposta que está na tela é enviada e guardada para revisão. No Chat, essa resposta pode repetir trechos do que você escreveu.',
    ...
    'privacy.use.ai': 'Leituras de IA. A foto ou o texto que você envia — Palma, Rosto, Pé, Pintas, Café, Sonhos, Chat, Insight da Semana e a reflexão que você manda lapidar — passa pelo nosso servidor e é enviado a um serviço de IA de terceiros (Anthropic), que gera a interpretação. O nosso servidor não guarda a foto nem o texto: fica só a contagem de quantas leituras foram feitas no dia, sem conteúdo nenhum. O que a Anthropic mantém dessa chamada segue a política dela e não está sob o nosso controle. Uma exceção: se você tocar em "Reportar esta resposta", a resposta denunciada é guardada — leia o item de denúncia logo abaixo.',
  ...
  es: {
    ...
    'report.body': 'Esta respuesta fue generada por IA. Elige el motivo y la respuesta que está en pantalla se envía y se guarda para revisión. En el Chat, esa respuesta puede repetir partes de lo que escribiste.',
    ...
    'privacy.use.ai': 'Lecturas de IA. La foto o el texto que envías — Palma, Rostro, Pie, Lunares, Café, Sueños, Chat, Insight de la Semana y la reflexión que mandas pulir — pasa por nuestro servidor y se envía a un servicio de IA de terceros (Anthropic), que genera la interpretación. Nuestro servidor no guarda la foto ni el texto: solo queda el conteo de cuántas lecturas se hicieron en el día, sin contenido alguno. Lo que Anthropic conserva de esa llamada sigue su propia política y no está bajo nuestro control. Una excepción: si tocas "Reportar esta respuesta", la respuesta reportada sí se guarda — lee el punto de reportes justo abajo.',
    ...
    'privacy.delete.message': 'Esto borra para siempre, en este dispositivo, los nombres, signos, fechas y horas de nacimiento, la ciudad y la racha guardada — y borra también, en nuestro servidor, el historial anónimo de pasos de este dispositivo y la suscripción del recordatorio diario. NO se van por aquí: lo que está en el Diario Cósmico (cada entrada se borra dentro del propio Diario), tu cuenta de acceso y su vínculo con la suscripción (Perfil > Eliminar cuenta), lo que publicaste en el feed social (lo borras tú, publicación por publicación, dentro del propio feed) y los reportes y bloqueos que hiciste. Esta acción no se puede deshacer.',
  ...
  en: {
    ...
    'report.body': 'This response was generated by AI. Pick a reason and the response on screen is sent and stored for review. In the Chat, that response may repeat parts of what you wrote.',
    ...
    'privacy.use.ai': "AI readings. The photo or text you send — Palm, Face, Foot, Moles, Coffee, Dreams, Chat, Weekly Insight and the reflection you ask us to polish — passes through our server and is sent to a third-party AI service (Anthropic), which generates the interpretation. Our server does not keep the photo or the text: all that stays is a count of how many readings were made that day, with no content at all. Whatever Anthropic keeps of that call follows Anthropic's own policy and is outside our control. One exception: if you tap \"Report this response\", the reported response is stored — see the reporting item just below.",
