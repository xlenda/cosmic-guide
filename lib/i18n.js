...
const RITUAIS_I18N = {
  pt: {
    ...
    'rituais.aviso.label': 'Antes de qualquer ritual',
  ...
  es: {
    ...
    'rituais.aviso.label': 'Antes de cualquier ritual',
  ...
  en: {
    ...
    'rituais.aviso.label': 'Before any ritual',
    ...
    'rituais.today.skyOff':
      'On this device the app could not work out the Moon phase right now. Only the rituals that ask for the day of the week are left — that one is calendar arithmetic and still holds. Nothing was made up to fill the list.',
...
const CALENDARIO_COSMICO_I18N = {
  pt: {
    ...
    'calendario.intro': 'Num mês qualquer o céu tem umas poucas datas em que alguma coisa acontece de fato: a Lua fecha o ciclo, o Sol troca de signo, um planeta para e volta a andar. Passam batido porque ninguém avisa. Aqui está o mês inteiro, com dia e hora.',
  ...
  es: {
    ...
    'calendario.intro': 'En un mes cualquiera el cielo tiene unas pocas fechas en que algo pasa de verdad: la Luna cierra el ciclo, el Sol cambia de signo, un planeta se detiene y vuelve a andar. Pasan desapercibidas porque nadie avisa. Aquí está el mes entero, con día y hora.',
    'calendario.monthLabel': '{mes} de {ano}',
  ...
  en: {
    ...
    'calendario.intro': 'In any given month the sky has just a few dates when something actually happens: the Moon closes its cycle, the Sun changes sign, a planet stops and turns around. They slip by because nobody tells you. Here is the whole month, with day and time.',
    ...
    'calendario.gate.text': 'The month you are living in stays open forever, with no counter at all. Moving back and forth — seeing which day December brings its Full Moon, checking the month of someone birthday — comes with the subscription.',
