...
const PT = {
  ...
  'onboarding.headerTitle': 'O céu do dia em que você nasceu\nainda está ali em cima.',
  'onboarding.headerSub': 'Nove leituras pra abrir: horóscopo, mapa astral, tarô, sonhos, palma da mão, borra de café e mais. A primeira de cada uma é sua, sem cartão.',
  ...
  'home.sectionExplore': 'O que o céu tem pra você hoje',
  'home.sectionExploreSubtitle': 'Sozinho ou em casal — tudo aberto, escolha por onde começar',
  // LEITURAS ganhou rótulo próprio (12/09/2026, reforma de diagramação). A
  // primeira grade não tinha nome: ela usava o título do GRUPO ('Explore o
  // cosmos') como se fosse seu. Com as cinco grades dentro de uma faixa só, o
  // título do grupo é dito uma vez no alto da faixa, e a grade precisa do
  // nome dela — senão fica a única sem identificação entre cinco rotuladas.
  'home.sectionLeituras': 'Leituras',
  'home.sectionLeiturasSubtitle': 'O que o céu tem a dizer sobre você hoje',
  ...
  'home.sectionPraticasSubtitle': 'Pra quando ler não basta e você precisa fazer algo',
  'home.sectionDatas': 'Datas do céu',
  'home.sectionDatasSubtitle': 'O que o céu faz este mês — com dia e hora, não com achismo',
  'home.sectionCuriosidades': 'Curiosidades',
  'home.sectionCuriosidadesSubtitle': 'O que te contaram × o que a fonte diz — feito pra compartilhar',
  'home.sectionCouple': 'Recursos de casal',
  'home.sectionCoupleSubtitle': 'Abrem quando vocês dois estiverem no app',
  ...
  'home.card.horoscope.subtitle': 'O que a Lua diz de você hoje',
  'home.card.birthchart.title': 'Mapa Astral',
  'home.card.birthchart.subtitle': 'O céu da hora em que você nasceu',
  'home.card.tarot.title': 'O que as cartas veem em você',
  'home.card.tarot.subtitle': 'Três cartas para o que te aperta',
  'home.card.tarotAmor.title': 'Sua reconquista começa aqui',
  'home.card.tarotAmor.subtitle': 'A Madre Maria lê suas cartas e te guia, um dia de cada vez',
  'home.identidade.sol': 'Sol',
  'home.identidade.lua': 'Lua',
  'home.identidade.asc': 'Ascendente',
  'home.identidade.mapa': 'Mapa de Nascimento',
  'home.identidade.adicionar': 'Adicionar data de nascimento',
  'home.greetingNome': 'Olá, {nome}',
  'onboarding.nome.label': 'Como você quer ser chamado?',
  'onboarding.nome.placeholder': 'Seu nome (opcional)',
  'home.horoscopoDiario.title': 'Horóscopo Diário',
  'home.horoscopoDiario.ler': 'Ler completo',
  'horoscope.ficha.explorarMapa': 'Explorar Mapa',
  'horoscope.ficha.nascimento': 'Nascimento',
  'tarot.info.title': 'Suas Informações',
  'tarot.info.vazio': 'Conte um pouco sobre você para a leitura',
  'tarot.info.editar': 'Editar',
  'tarot.info.salvar': 'Salvar',
  'tarot.info.genero': 'Gênero',
  'tarot.info.genero.feminino': 'Feminino',
  'tarot.info.genero.masculino': 'Masculino',
  'tarot.info.genero.outro': 'Outro',
  'tarot.info.idade': 'Idade',
  'tarot.info.profissao': 'Profissão',
  'tarot.info.estadoCivil': 'Relacionamento',
  'tarot.info.estadoCivil.solteiro': 'Solteiro(a)',
  'tarot.info.estadoCivil.namorando': 'Namorando',
  'tarot.info.estadoCivil.casado': 'Casado(a)',
  'tarot.info.estadoCivil.separado': 'Separado(a)',
  'home.card.compatibility.title': 'Compatibilidade',
  'home.card.compatibility.subtitle': 'Vocês dois, medidos no céu',
  'home.card.timeline.title': 'A história que vocês escreveram',
  'home.card.timeline.subtitle': 'Guarde as datas e os momentos de vocês dois',
  'home.card.reconectar.title': 'Quando o silêncio esfria',
  'home.card.reconectar.subtitle': 'Conversas guiadas pra voltar a se aproximar',
  'home.card.descobrir.title': 'Descobrir',
  'home.card.descobrir.subtitle': 'Perguntas que vocês nunca se fizeram',
  'home.card.agir.title': 'Agir',
  // As duas portas de casal (10/09/2026) — a fusão das seis telas antigas.
  'nosHoje.title': 'Nós Hoje',
  'nosHoje.subtitle': 'O que dá pra fazer juntos agora',
  // OS RÓTULOS CURTOS DAS ABAS (14/09/2026). Medido no ar: o chip tem 90px
  // e 'Quando o silêncio esfria' pede 138px — cortava no meio da palavra.
  // Em 'Nossa História' era pior: 184px num chip de 90. São chaves NOVAS
  // porque home.card.*.title também titula a PÁGINA (GradientHeader de
  // AgirScreen/DescobrirScreen), onde a frase longa é o que dá alma.
  // Rótulo de aba é placa, não frase: uma palavra, que cabe nos 3 idiomas.
  'aba.agir': 'Agir',
  'aba.reconectar': 'Reconectar',
  'aba.descobrir': 'Descobrir',
  'aba.timeline': 'Linha',
  'aba.progresso': 'Progresso',
  'aba.retrospectiva': 'Retrospectiva',
  'nossaHistoria.title': 'Nossa História',
  'nossaHistoria.subtitle': 'Memórias, conquistas e o ano de vocês',
  'home.card.agir.subtitle': 'Um gesto pequeno hoje, do tamanho que dá',
  'home.card.progresso.title': 'Quanto vocês já caminharam',
  'home.card.progresso.subtitle': 'Sua sequência de dias e as conquistas do casal',
  'home.card.retrospectiva.title': 'O ano de vocês em uma tela',
  'home.card.retrospectiva.subtitle': 'O resumo do ano do casal, pra ver e compartilhar',
  'home.card.dream.title': 'Aquele sonho quer te dizer algo',
  'home.card.dream.subtitle': 'Conte o sonho e receba a leitura simbólica',
  'home.card.lunarCalendar.title': 'Calendário Lunar',
  'home.card.lunarCalendar.subtitle': 'Em que fase a Lua está e o que ela move hoje',
  'home.card.palm.title': 'O que sua mão já sabe',
  'home.card.palm.subtitle': 'Uma foto da palma e a leitura das linhas',
  'home.card.coffee.title': 'Sua xícara tem recado',
  'home.card.coffee.subtitle': 'Fotografe a borra e leia os símbolos',
  'home.card.diary.title': 'Diário Cósmico',
  'home.card.diary.subtitle': 'Tudo que o céu já te disse, guardado pra reler',
  // Vazio: o subtitulo convida em vez de descrever (10/09/2026).
  'home.diary.empty': 'Guarde a primeira leitura — daqui a um mês você vai querer reler',
  'home.card.social.title': 'Você não é o único assim',
  // A enumeração listava 4 salas e COMMUNITY_ROOMS tem SEIS (lib/communityRooms.js).
  // As duas que faltavam não eram detalhe: 'Praça do Céu' é a sala aberta, porta de
  // entrada de quem chega sem signo salvo, e 'Entrelinhas' é a dos signos SEM aspecto
  // entre si — o caso que a doutrina do app trata como informação honesta, não como
  // ausência. Omitir justo essa apagava da vitrine a sala que encarna a lei da casa.
  'home.card.social.subtitle': 'Salas pela relação entre os signos: Praça do Céu, Espelhos, Pontes, Faíscas, Polos e Entrelinhas',
  ...
  'home.streak.empty': 'Dia 1 começa quando você abrir a primeira leitura',
  'reports.title': 'Relatórios',
  'reports.subtitle': 'Sua constância ao longo do tempo',
  'reports.streak_one': 'dia seguido',
  'reports.streak_other': 'dias seguidos',
  'reports.nextMilestone': 'até o marco de {days} dias',
  'reports.monthActive': 'dias ativos no mês',
  'reports.total': 'dias ativos no total',
  'reports.bestStreak': 'melhor sequência',
  'reports.evolutionTitle': 'Evolução',
  'reports.evolutionDesc': 'Dias ativos por mês, nos últimos seis meses.',
  'reports.legendaSemTipo': 'Atividade',
  ...
  'horoscope.pickerTitle': 'Sob qual signo você chegou?',
  ...
  'birthchart.astroPoint.ascendant': 'Ascendente',
  'birthchart.astroPoint.descendant': 'Descendente',
  'birthchart.astroPoint.midHeaven': 'Meio-do-Céu',
  'birthchart.astroPoint.imumCoeli': 'Fundo do Céu',
  ...
  'planos.header.subtitle': '3 planos · 7 dias grátis em todos',
  ...
  'planos.unlockTitle': 'Uma assinatura. O céu dos dois, aberto.',
  'planos.unlockTitleSolo': 'O que o céu diz de você — sem contar quantas vezes',
  'planos.benefit.1': '7 dias grátis pra sentir se é seu — cancela quando quiser',
  'planos.benefit.3': 'Reconectar — quando o silêncio entre vocês pesa, uma rota pra sair dele',
  'planos.benefit.4': 'Descobrir — perguntas que vocês nunca se fizeram, e jogos pra fazer hoje',
  'planos.benefit.5': 'Agir — a semana vira gesto, não intenção',
  'planos.benefit.6': 'Progresso e Retrospectiva: onde vocês estavam, onde estão agora',
  'planos.benefit.7': 'Linha do Tempo e cápsulas — o que vocês escreveram hoje, lido daqui a um ano',
  ...
  'planos.loginRequired.title': 'Seu acesso precisa de um nome',
  'planos.loginRequired.text': 'A conta é o que faz seu acesso te acompanhar: trocou de aparelho, perdeu o celular, ele continua seu.',
  ...
  'tokens.empty': 'Sua carteira está zerada. Toda leitura que você abre coloca token aqui dentro.',
  'tokens.emptyCta': 'Ganhar os primeiros',
  ...
  'diary.empty.cta': 'Guardar a primeira',
  ...
  'album.cardHidden': 'Cartas ainda não reveladas',
  'album.cardHiddenHint': 'Toque para descobrir como revelar estas cartas',
  'album.cardHiddenTitle': 'Estas cartas ainda estão guardadas',
  'album.cardHiddenBody': 'Elas entram no seu álbum depois de aparecerem em uma tiragem. Continue tirando cartas para revelar a coleção aos poucos.',
  ...
  // Cabeçalho da tela (10/09/2026). 'camino' e não 'jornada' no ES:
  // jornada em espanhol é dia de trabalho, o falso amigo clássico.
  'diary.headerTitle': 'Diário Cósmico',
  'diary.headerSubtitle': 'Sua jornada até aqui',
  'diary.weekly.loading': 'Buscando o fio condutor da sua semana...',
  'diary.close': 'Fechar',
  'diary.empty.waiting': 'O céu não parou um dia. Sua página é que ainda está em branco.',
  // 12/09/2026: eram as duas últimas strings cravadas em português dentro de
  // screens/DiaryScreen.js — quem abria o app em ES ou EN via o rótulo do
  // Insight e o parágrafo do diário vazio em português, no meio de uma tela
  // já traduzida. Texto idêntico ao que estava no código, só mudou de lugar.
  'diary.weekly.label': 'INSIGHT DA SEMANA',
  'diary.empty.desc': 'Toda leitura de tarô, palma, rosto, pé, pintas, café ou sonho que você fizer aparece aqui, guardadinha para você reviver quando quiser.',
  ...
  'tarot.subtitle': 'O que você não consegue parar de pensar? Traga para as cartas.',
  'tarot.album': 'Álbum',
  'tarot.tap': 'Toque',
  'missions.today': 'Missões de hoje',
  'missions.storeLink': 'trocar tokens por recompensas na Loja',
  // Títulos e descrições das 13 missões diárias (lib/missions.js MISSION_POOL).
  // Até 13/09/2026 só 'conversa-mistica' declarava chave — e nem essa chegava
  // à tela, porque getTodaysMissions() não repassava titleKey/descKey. As
  // treze apareciam em português pra quem lia o app em ES ou EN. Agora todas
  // declaram chave, o motor repassa, e o texto do pool vira só o fallback de
  // quem carregar o módulo sem idioma.
  'missions.done': 'Concluída — tokens no seu saldo \u2713',
  'missions.conversa-mistica.title': 'Converse com Órbi',
  'missions.conversa-mistica.desc': 'Leve uma pergunta concreta para o guia do app.',
  'missions.pensamento-do-dia.title': 'Leia o Pensamento Cósmico de hoje',
  'missions.pensamento-do-dia.desc': 'Abra o card do Pensamento Cósmico na Home e leia com calma.',
  'missions.compartilhar-frase.title': 'Compartilhe a Frase do Dia',
  'missions.compartilhar-frase.desc': 'Mande a frase de amor de hoje pra alguém especial.',
  'missions.calendario-lunar.title': 'Visite o Calendário Lunar',
  'missions.calendario-lunar.desc': 'Veja em que fase a Lua está hoje.',
  'missions.horoscopo-do-dia.title': 'Leia seu horóscopo de hoje',
  'missions.horoscopo-do-dia.desc': 'Confira o que o céu diz pro seu signo hoje.',
  'missions.tiragem-tarot.title': 'Tire suas cartas de Tarô',
  'missions.tiragem-tarot.desc': 'Complete uma tiragem de Tarô hoje.',
  'missions.leitura-do-dia.title': 'Complete uma leitura',
  'missions.leitura-do-dia.desc': 'Qualquer oráculo vale: Tarô, Palma, Café, Sonhos…',
  'missions.ritual-do-cafe.title': 'Faça o Ritual do Café',
  'missions.ritual-do-cafe.desc': 'Complete uma leitura de borra de café hoje.',
  'missions.leitura-de-sonho.title': 'Interprete um sonho',
  'missions.leitura-de-sonho.desc': 'Registre um sonho e receba a interpretação hoje.',
  'missions.insight-no-diario.title': 'Grave um insight no Diário',
  'missions.insight-no-diario.desc': 'Grave um insight seu numa leitura de hoje no Diário Cósmico.',
  'missions.ceu-de-hoje.title': 'Veja o céu de hoje pra você',
  'missions.ceu-de-hoje.desc': 'Como o céu de hoje toca o SEU mapa — não o de todo mundo.',
  'missions.proximos-dias.title': 'Veja o céu nos próximos dias',
  'missions.proximos-dias.desc': 'O que vem por aí: luas, ingressos e aspectos exatos.',
  'missions.ver-compatibilidade.title': 'Veja a compatibilidade de vocês',
  'missions.ver-compatibilidade.desc': 'Os dois signos em cinco áreas da vida, com o aspecto tradicional.',
  ...
  'retro.shareText': 'Ano de {voce} e {amor}: {memorias}, {capsulas} 💛',
  'retro.share.memory_one': 'memória guardada',
  'retro.share.memory_other': 'memórias guardadas',
  'retro.share.capsule_one': 'cápsula selada',
  'retro.share.capsule_other': 'cápsulas seladas',
...
const ES = {
  // Onboarding — a escolha "só eu / eu e meu par", 1ª tela de quem chega pelo link
  'onboarding.headerTitle': 'El cielo del día en que naciste\ntodavía está ahí arriba.',
  'onboarding.headerSub': 'Nueve lecturas para abrir: horóscopo, carta astral, tarot, sueños, palma de la mano, poso de café y más. La primera de cada una es tuya, sin tarjeta.',
  ...
  'home.sectionExplore': 'Lo que el cielo tiene para ti hoy',
  'home.sectionExploreSubtitle': 'Solo o en pareja — todo abierto, elige por dónde empezar',
  'home.sectionLeituras': 'Lecturas',
  'home.sectionLeiturasSubtitle': 'Lo que el cielo tiene que decir sobre ti hoy',
  'home.sectionPraticas': 'Prácticas',
  'home.sectionPraticasSubtitle': 'Para cuando leer no alcanza y necesitas hacer algo',
  'home.sectionDatas': 'Fechas del cielo',
  'home.sectionDatasSubtitle': 'Lo que el cielo hace este mes — con día y hora, no con suposiciones',
  'home.sectionCuriosidades': 'Curiosidades',
  'home.sectionCuriosidadesSubtitle': 'Lo que te contaron × lo que dice la fuente — hecho para compartir',
  'home.sectionCouple': 'Recursos de pareja',
  'home.sectionCoupleSubtitle': 'Se abren cuando los dos estén en la app',
  'home.sectionCosmicEvent': 'Evento cósmico',
  ...
  'home.card.horoscope.title': 'Horóscopo',
  'home.card.horoscope.subtitle': 'Lo que la Luna dice de ti hoy',
  'home.card.birthchart.title': 'Carta Astral',
  'home.card.birthchart.subtitle': 'El cielo de la hora en que naciste',
  'home.card.tarot.title': 'Lo que las cartas ven en ti',
  'home.card.tarot.subtitle': 'Tres cartas para lo que te aprieta',
  'home.card.tarotAmor.title': 'Tu reconquista empieza aquí',
  'home.card.tarotAmor.subtitle': 'La Madre María lee tus cartas y te guía, un día a la vez',
  'home.identidade.sol': 'Sol',
  'home.identidade.lua': 'Luna',
  'home.identidade.asc': 'Ascendente',
  'home.identidade.mapa': 'Carta Natal',
  'home.identidade.adicionar': 'Añadir fecha de nacimiento',
  'home.greetingNome': 'Hola, {nome}',
  'onboarding.nome.label': '¿Cómo quieres que te llamemos?',
  'onboarding.nome.placeholder': 'Tu nombre (opcional)',
  'home.horoscopoDiario.title': 'Horóscopo Diario',
  'home.horoscopoDiario.ler': 'Leer completo',
  'horoscope.ficha.explorarMapa': 'Explorar Carta',
  'horoscope.ficha.nascimento': 'Nacimiento',
  'tarot.info.title': 'Tu Información',
  'tarot.info.vazio': 'Cuéntanos un poco de ti para la lectura',
  'tarot.info.editar': 'Editar',
  'tarot.info.salvar': 'Guardar',
  'tarot.info.genero': 'Género',
  'tarot.info.genero.feminino': 'Femenino',
  'tarot.info.genero.masculino': 'Masculino',
  'tarot.info.genero.outro': 'Otro',
  'tarot.info.idade': 'Edad',
  'tarot.info.profissao': 'Profesión',
  'tarot.info.estadoCivil': 'Relación',
  'tarot.info.estadoCivil.solteiro': 'Soltero(a)',
  'tarot.info.estadoCivil.namorando': 'En pareja',
  'tarot.info.estadoCivil.casado': 'Casado(a)',
  'tarot.info.estadoCivil.separado': 'Separado(a)',
  'home.card.compatibility.title': 'Compatibilidad',
  'home.card.compatibility.subtitle': 'Ustedes dos, medidos en el cielo',
  'home.card.timeline.title': 'La historia que ustedes escribieron',
  'home.card.timeline.subtitle': 'Guarden las fechas y los momentos de los dos',
  'home.card.reconectar.title': 'Cuando el silencio enfría',
  'home.card.reconectar.subtitle': 'Conversaciones guiadas para volver a acercarse',
  'home.card.descobrir.title': 'Descubrir',
  'home.card.descobrir.subtitle': 'Preguntas que nunca se hicieron',
  'home.card.agir.title': 'Actuar',
  'nosHoje.title': 'Nosotros Hoy',
  'nosHoje.subtitle': 'Lo que pueden hacer juntos ahora',
  'aba.agir': 'Actuar',
  'aba.reconectar': 'Reconectar',
  'aba.descobrir': 'Descubrir',
  'aba.timeline': 'Línea',
  'aba.progresso': 'Progreso',
  'aba.retrospectiva': 'Retrospectiva',
  'nossaHistoria.title': 'Nuestra Historia',
  'nossaHistoria.subtitle': 'Recuerdos, logros y el año de ustedes',
  'home.card.agir.subtitle': 'Un gesto pequeño hoy, del tamaño que puedas',
  'home.card.progresso.title': 'Cuánto ya caminaron',
  'home.card.progresso.subtitle': 'Tu racha de días y los logros de la pareja',
  'home.card.retrospectiva.title': 'El año de ustedes en una pantalla',
  'home.card.retrospectiva.subtitle': 'El resumen del año de la pareja, para ver y compartir',
  'home.card.dream.title': 'Ese sueño quiere decirte algo',
  'home.card.dream.subtitle': 'Cuenta el sueño y recibe la lectura simbólica',
  'home.card.lunarCalendar.title': 'Calendario Lunar',
  'home.card.lunarCalendar.subtitle': 'En qué fase está la Luna y qué mueve hoy',
  'home.card.palm.title': 'Lo que tu mano ya sabe',
  'home.card.palm.subtitle': 'Una foto de la palma y la lectura de las líneas',
  'home.card.coffee.title': 'Tu taza tiene un recado',
  'home.card.coffee.subtitle': 'Fotografía los posos y lee los símbolos',
  'home.card.diary.title': 'Diario Cósmico',
  'home.card.diary.subtitle': 'Todo lo que el cielo ya te dijo, guardado para releer',
  'home.diary.empty': 'Guarda la primera lectura — en un mes vas a querer releerla',
  'home.card.social.title': 'No eres el único así',
  'home.card.social.subtitle': 'Salas por la relación entre los signos: Plaza del Cielo, Espejos, Puentes, Chispas, Polos y Entre líneas',
  ...
  'home.streak.empty': 'El día 1 empieza cuando abras la primera lectura',
  'reports.title': 'Informes',
  'reports.subtitle': 'Tu constancia a lo largo del tiempo',
  'reports.streak_one': 'día seguido',
  'reports.streak_other': 'días seguidos',
  'reports.nextMilestone': 'hasta la meta de {days} días',
  'reports.monthActive': 'días activos en el mes',
  'reports.total': 'días activos en total',
  'reports.bestStreak': 'mejor racha',
  'reports.evolutionTitle': 'Evolución',
  'reports.evolutionDesc': 'Días activos por mes, en los últimos seis meses.',
  'reports.legendaSemTipo': 'Actividad',
  ...
  'horoscope.pickerTitle': '¿Bajo qué signo llegaste?',
  'horoscope.element': 'Elemento {element}',
  ...
  'birthchart.astroPoint.ascendant': 'Ascendente',
  'birthchart.astroPoint.descendant': 'Descendente',
  'birthchart.astroPoint.midHeaven': 'Medio Cielo',
  'birthchart.astroPoint.imumCoeli': 'Fondo del Cielo',
  ...
  'planos.header.subtitle': '3 planes · 7 días gratis en todos',
  'planos.unlockTitle': 'Una suscripción. El cielo de los dos, abierto.',
  'planos.unlockTitleSolo': 'Lo que el cielo dice de ti — sin contar cuántas veces',
  'planos.benefit.1': '7 días gratis para sentir si es tuyo — cancela cuando quieras',
  'planos.benefit.3': 'Reconectar — cuando el silencio entre ustedes pesa, una ruta para salir de él',
  'planos.benefit.4': 'Descubrir — preguntas que nunca se hicieron, y juegos para hoy',
  'planos.benefit.5': 'Actuar — la semana se vuelve gesto, no intención',
  'planos.benefit.6': 'Progreso y Retrospectiva: dónde estaban, dónde están ahora',
  'planos.benefit.7': 'Línea de Tiempo y cápsulas — lo que escriben hoy, leído dentro de un año',
  ...
  'planos.loginRequired.title': 'Tu acceso necesita un nombre',
  'planos.loginRequired.text': 'La cuenta es lo que hace que tu acceso te acompañe: cambiaste de aparato, perdiste el celular, sigue siendo tuyo.',
  ...
  'tokens.empty': 'Tu billetera está en cero. Cada lectura que abres pone tokens aquí dentro.',
  'tokens.emptyCta': 'Ganar los primeros',
  ...
  'diary.empty.cta': 'Guardar la primera',
  ...
  'album.cardHidden': 'Cartas todavía no reveladas',
  'album.cardHiddenHint': 'Toca para descubrir cómo revelar estas cartas',
  'album.cardHiddenTitle': 'Estas cartas todavía están guardadas',
  'album.cardHiddenBody': 'Entrarán en tu álbum después de aparecer en una tirada. Sigue sacando cartas para revelar la colección poco a poco.',
  ...
  'diary.headerTitle': 'Diario Cósmico',
  'diary.headerSubtitle': 'Tu camino hasta aquí',
  'diary.weekly.loading': 'Buscando el hilo conductor de tu semana...',
  'diary.close': 'Cerrar',
  'diary.empty.waiting': 'El cielo no paró ni un día. Tu página es la que sigue en blanco.',
  'diary.weekly.label': 'INSIGHT DE LA SEMANA',
  'diary.empty.desc': 'Cada lectura de tarot, palma, rostro, pie, lunares, café o sueño que hagas aparece aquí, guardada para que la vuelvas a vivir cuando quieras.',
  ...
  'tarot.subtitle': '¿Qué es eso que no logras dejar de pensar? Tráelo a las cartas.',
  'tarot.album': 'Álbum',
  'tarot.tap': 'Toca',
  'missions.today': 'Misiones de hoy',
  'missions.storeLink': 'cambiar fichas por recompensas en la Tienda',
  'missions.done': 'Completada — fichas en tu saldo \u2713',
  'missions.conversa-mistica.title': 'Conversa con Órbi',
  'missions.conversa-mistica.desc': 'Lleva una pregunta concreta al guía de la app.',
  'missions.pensamento-do-dia.title': 'Lee el Pensamiento Cósmico de hoy',
  'missions.pensamento-do-dia.desc': 'Abre la tarjeta del Pensamiento Cósmico en el Inicio y léela con calma.',
  'missions.compartilhar-frase.title': 'Comparte la Frase del Día',
  'missions.compartilhar-frase.desc': 'Envía la frase de amor de hoy a alguien especial.',
  'missions.calendario-lunar.title': 'Visita el Calendario Lunar',
  'missions.calendario-lunar.desc': 'Mira en qué fase está la Luna hoy.',
  'missions.horoscopo-do-dia.title': 'Lee tu horóscopo de hoy',
  'missions.horoscopo-do-dia.desc': 'Mira lo que el cielo dice para tu signo hoy.',
  'missions.tiragem-tarot.title': 'Tira tus cartas de Tarot',
  'missions.tiragem-tarot.desc': 'Completa una tirada de Tarot hoy.',
  'missions.leitura-do-dia.title': 'Completa una lectura',
  'missions.leitura-do-dia.desc': 'Cualquier oráculo vale: Tarot, Palma, Café, Sueños…',
  'missions.ritual-do-cafe.title': 'Haz el Ritual del Café',
  'missions.ritual-do-cafe.desc': 'Completa una lectura de borra de café hoy.',
  'missions.leitura-de-sonho.title': 'Interpreta un sueño',
  'missions.leitura-de-sonho.desc': 'Registra un sueño y recibe la interpretación hoy.',
  'missions.insight-no-diario.title': 'Graba un insight en el Diario',
  'missions.insight-no-diario.desc': 'Graba un insight tuyo en una lectura de hoy en el Diario Cósmico.',
  'missions.ceu-de-hoje.title': 'Mira el cielo de hoy para ti',
  'missions.ceu-de-hoje.desc': 'Cómo el cielo de hoy toca TU carta — no la de todo el mundo.',
  'missions.proximos-dias.title': 'Mira el cielo en los próximos días',
  'missions.proximos-dias.desc': 'Lo que viene: lunas, ingresos y aspectos exactos.',
  'missions.ver-compatibilidade.title': 'Mira la compatibilidad de ustedes',
  'missions.ver-compatibilidade.desc': 'Los dos signos en cinco áreas de la vida, con el aspecto tradicional.',
  ...
  'retro.shareText': 'El año de {voce} y {amor}: {memorias}, {capsulas} 💛',
  'retro.share.memory_one': 'recuerdo guardado',
  'retro.share.memory_other': 'recuerdos guardados',
  'retro.share.capsule_one': 'cápsula sellada',
  'retro.share.capsule_other': 'cápsulas selladas',
...
const EN = {
  // Onboarding — a escolha "só eu / eu e meu par", 1ª tela de quem chega pelo link
  'onboarding.headerTitle': 'The sky you were born under\nis still up there.',
  'onboarding.headerSub': 'Nine readings to open: horoscope, birth chart, tarot, dreams, palm, coffee grounds and more. The first of each is yours, no card.',
  ...
  'home.sectionExplore': 'What the sky has for you today',
  'home.sectionExploreSubtitle': 'Alone or as a couple — everything open, pick where to start',
  'home.sectionLeituras': 'Readings',
  'home.sectionLeiturasSubtitle': 'What the sky has to say about you today',
  'home.sectionPraticas': 'Practices',
  'home.sectionPraticasSubtitle': 'For when reading is not enough and you need to do something',
  'home.sectionDatas': 'Sky dates',
  'home.sectionDatasSubtitle': 'What the sky does this month — with day and time, not guesswork',
  'home.sectionCuriosidades': 'Curiosities',
  'home.sectionCuriosidadesSubtitle': 'What they told you × what the source says — made to share',
  'home.sectionCouple': 'Couple features',
  'home.sectionCoupleSubtitle': 'They open once the two of you are both in the app',
  ...
  'home.card.horoscope.subtitle': 'What the Moon says about you today',
  'home.card.birthchart.title': 'Birth Chart',
  'home.card.birthchart.subtitle': 'The sky of the hour you were born',
  'home.card.tarot.title': 'What the cards see in you',
  'home.card.tarot.subtitle': 'Three cards for what weighs on you',
  'home.card.tarotAmor.title': 'Your comeback starts here',
  'home.card.tarotAmor.subtitle': 'Madre Maria reads your cards and guides you, one day at a time',
  'home.identidade.sol': 'Sun',
  'home.identidade.lua': 'Moon',
  'home.identidade.asc': 'Rising',
  'home.identidade.mapa': 'Birth Chart',
  'home.identidade.adicionar': 'Add your birth date',
  'home.greetingNome': 'Hi, {nome}',
  'onboarding.nome.label': 'What should we call you?',
  'onboarding.nome.placeholder': 'Your name (optional)',
  'home.horoscopoDiario.title': 'Daily Horoscope',
  'home.horoscopoDiario.ler': 'Read in full',
  'horoscope.ficha.explorarMapa': 'Explore Chart',
  'horoscope.ficha.nascimento': 'Birth',
  'tarot.info.title': 'Your Details',
  'tarot.info.vazio': 'Tell us a bit about you for the reading',
  'tarot.info.editar': 'Edit',
  'tarot.info.salvar': 'Save',
  'tarot.info.genero': 'Gender',
  'tarot.info.genero.feminino': 'Female',
  'tarot.info.genero.masculino': 'Male',
  'tarot.info.genero.outro': 'Other',
  'tarot.info.idade': 'Age',
  'tarot.info.profissao': 'Occupation',
  'tarot.info.estadoCivil': 'Relationship',
  'tarot.info.estadoCivil.solteiro': 'Single',
  'tarot.info.estadoCivil.namorando': 'Dating',
  'tarot.info.estadoCivil.casado': 'Married',
  'tarot.info.estadoCivil.separado': 'Separated',
  'home.card.compatibility.title': 'Compatibility',
  'home.card.compatibility.subtitle': 'The two of you, measured in the sky',
  'home.card.timeline.title': 'The story the two of you wrote',
  'home.card.timeline.subtitle': 'Keep the dates and the moments that are yours',
  'home.card.reconectar.title': 'When the silence turns cold',
  'home.card.reconectar.subtitle': 'Guided conversations to get close again',
  'home.card.descobrir.title': 'Discover',
  'home.card.descobrir.subtitle': 'Questions you\'ve never asked each other',
  'home.card.agir.title': 'Take Action',
  'nosHoje.title': 'Us Today',
  'nosHoje.subtitle': 'What you can do together right now',
  'aba.agir': 'Act',
  'aba.reconectar': 'Reconnect',
  'aba.descobrir': 'Discover',
  'aba.timeline': 'Timeline',
  'aba.progresso': 'Progress',
  'aba.retrospectiva': 'Recap',
  'nossaHistoria.title': 'Our Story',
  'nossaHistoria.subtitle': 'Memories, milestones and your year',
  'home.card.agir.subtitle': 'One small gesture today, whatever size you have',
  'home.card.progresso.title': 'How far you\'ve come together',
  'home.card.progresso.subtitle': 'Your day streak and the couple\'s achievements',
  'home.card.retrospectiva.title': 'Your year on one screen',
  'home.card.retrospectiva.subtitle': 'The couple\'s year in review, to see and share',
  'home.card.dream.title': 'That dream is trying to tell you something',
  'home.card.dream.subtitle': 'Describe the dream and get its symbolic reading',
  'home.card.lunarCalendar.title': 'Lunar Calendar',
  'home.card.lunarCalendar.subtitle': 'Which phase the Moon is in and what it stirs today',
  'home.card.palm.title': 'What your hand already knows',
  'home.card.palm.subtitle': 'One photo of your palm and a reading of the lines',
  'home.card.coffee.title': 'Your cup has a message',
  'home.card.coffee.subtitle': 'Photograph the grounds and read the symbols',
  'home.card.diary.title': 'Cosmic Diary',
  'home.card.diary.subtitle': 'Everything the sky has told you, saved to reread',
  'home.diary.empty': 'Save the first one — in a month you\'ll want to read it again',
  'home.card.social.title': 'You\'re not the only one like this',
  'home.card.social.subtitle': 'Rooms by how the signs relate: Sky Plaza, Mirrors, Bridges, Sparks, Poles and Between the Lines',
  ...
  'home.streak.empty': 'Day 1 starts when you open the first one',
  'reports.title': 'Reports',
  'reports.subtitle': 'Your consistency over time',
  'reports.streak_one': 'day in a row',
  'reports.streak_other': 'days in a row',
  'reports.nextMilestone': 'to the {days}-day milestone',
  'reports.monthActive': 'active days this month',
  'reports.total': 'active days in total',
  'reports.bestStreak': 'best streak',
  'reports.evolutionTitle': 'Evolution',
  'reports.evolutionDesc': 'Active days per month, over the last six months.',
  'reports.legendaSemTipo': 'Activity',
  ...
  'horoscope.pickerTitle': 'Under which sign did you arrive?',
  ...
  'birthchart.astroPoint.ascendant': 'Ascendant',
  'birthchart.astroPoint.descendant': 'Descendant',
  'birthchart.astroPoint.midHeaven': 'Midheaven',
  'birthchart.astroPoint.imumCoeli': 'Imum Coeli',
  ...
  'planos.header.subtitle': '3 plans · 7 days free on all of them',
  'planos.unlockTitle': 'One subscription. The sky of you both, open.',
  'planos.unlockTitleSolo': 'What the sky says about you — without counting how many times',
  'planos.benefit.1': '7 days free to feel if it is yours — cancel whenever you want',
  'planos.benefit.3': 'Reconnect — when the silence between you weighs, a route out of it',
  'planos.benefit.4': 'Discover — questions you never asked each other, and games for tonight',
  'planos.benefit.5': 'Act — the week becomes a gesture, not an intention',
  'planos.benefit.6': 'Progress and Recap: where you were, where you are now',
  'planos.benefit.7': 'Timeline and time capsules — what you write today, read a year from now',
  'planos.benefit.8': 'Written from primary sources: when tradition and the internet disagree, we show you the source — the work, the author and the century.',
  ...
  'planos.cta.trial': 'Start my 7 days free →',
  ...
  'planos.loginRequired.title': 'Your access needs a name',
  'planos.loginRequired.text': 'The account is what makes your access follow you: new phone, lost phone, it is still yours.',
  ...
  'tokens.empty': 'Your wallet is empty. Every reading you open drops tokens in here.',
  'tokens.emptyCta': 'Earn the first ones',
  ...
  'diary.empty.cta': 'Keep the first one',
  ...
  'album.cardHidden': 'Cards not revealed yet',
  'album.cardHiddenHint': 'Tap to learn how to reveal these cards',
  'album.cardHiddenTitle': 'These cards are still sealed',
  'album.cardHiddenBody': 'They join your album after appearing in a reading. Keep drawing cards to reveal your collection little by little.',
  ...
  'diary.headerTitle': 'Cosmic Diary',
  'diary.headerSubtitle': 'Your journey so far',
  'diary.weekly.loading': 'Looking for the thread running through your week...',
  'diary.close': 'Close',
  'diary.empty.waiting': 'The sky hasn’t paused a single day. Your page is the one still blank.',
  'diary.weekly.label': 'INSIGHT OF THE WEEK',
  'diary.empty.desc': 'Every tarot, palm, face, foot, mole, coffee or dream reading you do shows up here, kept for you to live again whenever you want.',
  ...
  'tarot.subtitle': 'What can you not stop thinking about? Bring it to the cards.',
  'tarot.album': 'Album',
  'tarot.tap': 'Tap',
  'missions.today': "Today's missions",
  'missions.storeLink': 'trade tokens for rewards in the Store',
  'missions.done': 'Done — tokens in your balance \u2713',
  'missions.conversa-mistica.title': 'Talk with Órbi',
  'missions.conversa-mistica.desc': 'Bring one concrete question to the app guide.',
  'missions.pensamento-do-dia.title': "Read today's Cosmic Thought",
  'missions.pensamento-do-dia.desc': 'Open the Cosmic Thought card on Home and read it slowly.',
  'missions.compartilhar-frase.title': 'Share the Phrase of the Day',
  'missions.compartilhar-frase.desc': "Send today's love phrase to someone special.",
  'missions.calendario-lunar.title': 'Visit the Lunar Calendar',
  'missions.calendario-lunar.desc': 'See which phase the Moon is in today.',
  'missions.horoscopo-do-dia.title': "Read today's horoscope",
  'missions.horoscopo-do-dia.desc': 'See what the sky says for your sign today.',
  'missions.tiragem-tarot.title': 'Pull your Tarot cards',
  'missions.tiragem-tarot.desc': 'Complete a Tarot spread today.',
  'missions.leitura-do-dia.title': 'Complete a reading',
  'missions.leitura-do-dia.desc': 'Any oracle counts: Tarot, Palm, Coffee, Dreams…',
  'missions.ritual-do-cafe.title': 'Do the Coffee Ritual',
  'missions.ritual-do-cafe.desc': 'Complete a coffee-ground reading today.',
  'missions.leitura-de-sonho.title': 'Interpret a dream',
  'missions.leitura-de-sonho.desc': 'Write down a dream and get the interpretation today.',
  'missions.insight-no-diario.title': 'Record an insight in the Journal',
  'missions.insight-no-diario.desc': "Record an insight of yours on one of today's readings in the Cosmic Journal.",
  'missions.ceu-de-hoje.title': "See today's sky for you",
  'missions.ceu-de-hoje.desc': "How today's sky touches YOUR chart — not everyone else's.",
  'missions.proximos-dias.title': 'See the sky in the coming days',
  'missions.proximos-dias.desc': "What's ahead: moons, ingresses and exact aspects.",
  'missions.ver-compatibilidade.title': 'See how compatible you two are',
  'missions.ver-compatibilidade.desc': 'Both signs across five areas of life, with the traditional aspect.',
  ...
  'retro.share': 'Share',
  'retro.shareText': '{voce} and {amor}, this year: {memorias}, {capsulas} 💛',
  'retro.share.memory_one': 'memory kept',
  'retro.share.memory_other': 'memories kept',
  'retro.share.capsule_one': 'capsule sealed',
  'retro.share.capsule_other': 'capsules sealed',
...
const CONFIANCA = {
  ...
  es: {
    'reading.genericNote':
      'La lectura personalizada por IA no respondió ahora, así que esta es una lectura simbólica general — no un análisis de lo que enviaste. Prueba de nuevo en unos minutos.',
    'help.faq.cancel.answer':
      'Cuando quieras, sin hablar con nadie. Tu suscripción la cobra Hotmart, y ahí mismo se cancela: entra en tu área de compras con el correo que usaste, abre la suscripción de Cosmic Guide y toca cancelar. El acceso sigue hasta el final del período ya pagado.',
    'help.faq.cancel.cta': 'Abrir mi área de compras en Hotmart',
    'planos.legal.billingNote':
      'Cobro procesado por Hotmart. Se renueva solo al final de cada período y lo cancelas cuando quieras, directo en tu área de compras.',
...
const SOM_DO_CEU = {
  ...
  es: {
    ...
    'sound.warn.failed': 'No se pudo iniciar el sonido ahora. Prueba de nuevo.',
...
const ZODIAC_BODY_I18N = {
  pt: {
    ...
    'home.card.zodiacbody.subtitle': 'O que os médicos criam do corpo, do séc. I ao XVII',
  ...
  es: {
    ...
    'home.card.zodiacbody.subtitle': 'Lo que los médicos creían del cuerpo, del siglo I al XVII',
  ...
  en: {
    ...
    'home.card.zodiacbody.subtitle': 'What physicians believed about the body, 1st-17th c.',
...
const GROUNDING_I18N = {
  pt: {
    ...
    'home.card.grounding.subtitle': 'Respire e volte pro chão, em poucos minutos',
  ...
  es: {
    ...
    'home.card.grounding.subtitle': 'Respira y vuelve al suelo, en pocos minutos',
  ...
  en: {
    ...
    'home.card.grounding.subtitle': 'Breathe and come back down, in a few minutes',
...
const HOROSCOPE_SKY_I18N = {
  pt: {
    ...
    'horoscope.sky.factsTitle': 'O céu que está sobre você agora',
  ...
  es: {
    ...
    'horoscope.sky.factsTitle': 'El cielo que está sobre ti ahora',
  ...
  en: {
    ...
    'horoscope.sky.factsTitle': 'The sky that is above you right now',
...
const PLANOS_SOLO_I18N = {
  pt: {
    'planos.unlockTitleSolo': 'O que o céu diz de você — sem contar quantas vezes',
    'planos.benefit.solo.1': '7 dias grátis pra sentir se é seu — cancela quando quiser',
    'planos.benefit.solo.2': 'Horóscopo e Calendário Lunar sem limite: o céu de hoje e o do mês inteiro, calculados de verdade',
    'planos.benefit.solo.3': 'Seu Mapa Astral inteiro — aquele documento que você relê por anos',
    'planos.benefit.solo.4': 'Tarô sem limite — e cada carta que sai fica sua, no álbum das 78',
    'planos.benefit.solo.5': 'Aquele sonho estranho, a linha da sua mão, a borra no fundo da xícara: mande, quantas vezes quiser',
    'planos.benefit.solo.6': 'Órbi sempre aberto, pra falar do que a leitura mexeu e você não contou pra ninguém',
    'planos.benefit.solo.7': 'Compatibilidade sem limite: o seu mapa ao lado do de quem você quiser',
    'planos.benefit.solo.8': 'Escrito a partir de fonte primária: quando a tradição e a internet discordam, a gente mostra a fonte',
  },
  es: {
    'planos.unlockTitleSolo': 'Lo que el cielo dice de ti — sin contar cuántas veces',
    'planos.benefit.solo.1': '7 días gratis para sentir si es tuyo — cancela cuando quieras',
    'planos.benefit.solo.2': 'Horóscopo y Calendario Lunar sin límite: el cielo de hoy y el del mes entero, calculados de verdad',
    'planos.benefit.solo.3': 'Tu Carta Astral entera — ese documento que relees por años',
    'planos.benefit.solo.4': 'Tarot sin límite — y cada carta que sale queda tuya, en el álbum de 78',
    'planos.benefit.solo.5': 'Ese sueño raro, la línea de tu mano, el poso en el fondo de la taza: manda, todas las veces que quieras',
    'planos.benefit.solo.6': 'Órbi siempre abierto, para hablar de lo que la lectura movió y no le contaste a nadie',
    'planos.benefit.solo.7': 'Compatibilidad sin límite: tu carta al lado de la de quien quieras',
  ...
  en: {
    'planos.unlockTitleSolo': 'What the sky says about you — without counting how many times',
    'planos.benefit.solo.1': '7 days free to feel if it is yours — cancel whenever you want',
    'planos.benefit.solo.2': "Horoscope and Lunar Calendar with no limit: today's sky and the whole month, actually calculated",
    'planos.benefit.solo.3': 'Your full Birth Chart — the document you keep rereading for years',
    'planos.benefit.solo.4': 'Unlimited Tarot — and every card you draw stays yours, in the album of 78',
    'planos.benefit.solo.5': 'That strange dream, the line on your palm, the grounds at the bottom of the cup: send them, as many times as you want',
    'planos.benefit.solo.6': 'Órbi always open, to talk about what the reading stirred and you told no one',
    'planos.benefit.solo.7': "Unlimited Compatibility: your chart next to whoever's you want",
...
const RITUAIS_I18N = {
  pt: {
    ...
    'rituais.paywall.firstFree':
      'O primeiro ritual que você abrir fica seu pra sempre neste aparelho — ritual não se lê, se faz, e vários duram dias. Os outros vêm com a assinatura.',
    'rituais.paywall.used':
      'O ritual que ficou seu é "{titulo}" — esse abre sempre. Os outros esperam do outro lado da assinatura.',
  ...
  es: {
    ...
    'rituais.paywall.firstFree':
      'El primer ritual que abras queda tuyo para siempre en este aparato — un ritual no se lee, se hace, y varios duran días. Los demás vienen con la suscripción.',
    'rituais.paywall.used':
      'El ritual que quedó tuyo es "{titulo}" — ese abre siempre. Los demás esperan del otro lado de la suscripción.',
  ...
  en: {
    ...
    'rituais.paywall.firstFree':
      'The first ritual you open stays yours forever on this device — a ritual is not read, it is done, and several of them run for days. The others come with the subscription.',
    'rituais.paywall.used':
      'The ritual that became yours is "{titulo}" — that one always opens. The others are waiting on the other side of the subscription.',
...
const HOME_ENTRADAS_I18N = {
  pt: {
    ...
    'home.card.rituais.subtitle': 'Pra quando você precisa fazer, não só ler',
    'home.card.jornada.title': 'Jornada Guiada',
    'home.card.jornada.subtitle': 'Sete dias pra entender o que você sente',
    'home.card.calendario.title': 'Calendário Cósmico',
    'home.card.calendario.subtitle': 'As datas deste mês que mexem com você',
  ...
  es: {
    ...
    'home.card.rituais.subtitle': 'Para cuando necesitas hacer, no solo leer',
    'home.card.jornada.title': 'Camino Guiado',
    'home.card.jornada.subtitle': 'Siete días para entender lo que sientes',
    'home.card.calendario.title': 'Calendario Cósmico',
    'home.card.calendario.subtitle': 'Las fechas de este mes que te mueven',
  ...
  en: {
    ...
    'home.card.rituais.subtitle': 'For when you need to act, not just read',
    'home.card.jornada.title': 'Guided Journey',
    'home.card.jornada.subtitle': 'Seven days to understand what you feel',
    'home.card.calendario.title': 'Cosmic Calendar',
    'home.card.calendario.subtitle': 'This month\'s dates that stir things for you',
...
const LEVA_MITOS_EMOCOES_QUIZ_WALLPAPER_I18N = {
  pt: {
    'home.card.mitos.title': 'Quase tudo que te contaram é falso',
    'home.card.mitos.subtitle': 'O que te contaram × o que a fonte diz',
    'home.card.comovoceta.title': 'Como você tá?',
    'home.card.comovoceta.subtitle': 'Diz do seu jeito e a gente abre uma leitura pra isso',
    'home.card.quizcosmico.title': 'Você sabia?',
    'home.card.quizcosmico.subtitle': 'Sete perguntas por dia — quantas você acerta?',
  ...
  es: {
    'home.card.mitos.title': 'Casi todo lo que te contaron es falso',
    'home.card.mitos.subtitle': 'Lo que te contaron × lo que dice la fuente',
    'home.card.comovoceta.title': '¿Cómo estás?',
    'home.card.comovoceta.subtitle': 'Dilo a tu manera y abrimos una lectura para eso',
    'home.card.quizcosmico.title': '¿Sabías?',
    'home.card.quizcosmico.subtitle': 'Siete preguntas por día — ¿cuántas aciertas?',
  ...
  en: {
    'home.card.mitos.title': 'Almost everything you were told is false',
    'home.card.mitos.subtitle': 'What they told you × what the source says',
    'home.card.comovoceta.title': 'How are you?',
    'home.card.comovoceta.subtitle': 'Say it your way and we open a reading for it',
    'home.card.quizcosmico.title': 'Did you know?',
    'home.card.quizcosmico.subtitle': 'Seven questions a day — how many can you get?',
...
const PAYWALL_I18N = {
  ...
  es: {
    ...
    'onetimelock.quota.text.couple': 'La cuota gratuita vive en tu cuenta, no en el aparato. Suscríbete a Cosmic Guide y sigue sin límite, tú y tu pareja.',
    'onetimelock.quota.text.solo': 'La cuota gratuita vive en tu cuenta, no en el aparato. Suscríbete a Cosmic Guide y sigue sin límite.',
...
const CHROME_RESTANTE_I18N = {
  pt: {
    ...
    'diary.empty.fav': 'Uma leitura vai te acertar em cheio. Toque no coração dela e ela fica aqui, separada das outras.',
  },
  es: {
    ...
    'diary.empty.fav': 'Una lectura te va a dar justo en el centro. Toca su corazón y queda aquí, aparte de las demás.',
  },
  en: {
    ...
    'diary.empty.fav': 'One reading is going to land straight in the chest. Tap its heart and it stays here, apart from the rest.',
  },
};
...
const IDADE_REAL_CARD_I18N = {
  pt: {
    ...
    'home.card.idadereal.subtitle': 'A Superlua não tem 4.000 anos — e mais 29 datas',
  },
  es: {
    'home.card.idadereal.title': 'La edad real de cada cosa',
    'home.card.idadereal.subtitle': 'La Superluna no tiene 4.000 años — y 29 fechas más',
  },
  en: {
    'home.card.idadereal.title': 'How old things really are',
    'home.card.idadereal.subtitle': 'The Supermoon is not 4,000 years old — plus 29 more dates',
  },
};
...
const RETRO_LUA_I18N = {
  pt: {
    ...
    'home.card.retrolua.subtitle': 'O que você viveu desde a última Lua Nova',
  ...
  es: {
    ...
    'home.card.retrolua.subtitle': 'Lo que viviste desde la última Luna Nueva',
    ...
    'retroLua.disclaimer': 'Los números son el conteo de lo que tú mismo registraste aquí; las fechas de la Luna vienen de efemérides. Nada en esta pantalla fue estimado. Las lecturas son tradición simbólica, para reflexión y entretenimiento.',
    ...
    'retroLua.aguarde.descSemData': 'Cuenta tu ciclo desde la última Luna Nueva, y la Luna Llena es la mitad de él. Vuelve cuando la Luna esté llena.',
    ...
    'retroLua.vazio.desc': 'La retrospectiva sólo cuenta lo que tú mismo marcaste aquí — un check-in, una lectura. Empieza hoy y en la próxima Luna Llena va a tener qué contar.',
    'retroLua.vazio.cta': 'Ir a las lecturas',
  },
  en: {
    'home.card.retrolua.title': 'Full Moon Recap',
    'home.card.retrolua.subtitle': 'What you lived since the last New Moon',
...
const ELEMENTOS_I18N = {
  pt: {
    'birthchart.elements.title': 'De que matéria você é feito',
    'birthchart.elements.fire': 'Fogo',
    'birthchart.elements.earth': 'Terra',
    'birthchart.elements.air': 'Ar',
    'birthchart.elements.water': 'Água',
    'birthchart.ficha.elemento': 'Elemento',
    'birthchart.ficha.polaridade': 'Polaridade',
    'birthchart.ficha.modalidade': 'Modalidade',
    'birthchart.ficha.masculino': 'Masculino',
    'birthchart.ficha.feminino': 'Feminino',
    'birthchart.ficha.cardinal': 'Cardinal',
    'birthchart.ficha.fixo': 'Fixo',
    'birthchart.ficha.mutavel': 'Mutável',
  ...
  es: {
    'birthchart.elements.title': 'De qué materia estás hecho',
    'birthchart.elements.fire': 'Fuego',
    'birthchart.elements.earth': 'Tierra',
    'birthchart.elements.air': 'Aire',
    'birthchart.elements.water': 'Agua',
    'birthchart.ficha.elemento': 'Elemento',
    'birthchart.ficha.polaridade': 'Polaridad',
    'birthchart.ficha.modalidade': 'Modalidad',
    'birthchart.ficha.masculino': 'Masculino',
    'birthchart.ficha.feminino': 'Femenino',
    'birthchart.ficha.cardinal': 'Cardinal',
    'birthchart.ficha.fixo': 'Fijo',
    'birthchart.ficha.mutavel': 'Mutable',
    'birthchart.elements.reading.fogo':
  ...
  en: {
    'birthchart.elements.title': 'What you are made of',
    'birthchart.elements.fire': 'Fire',
    'birthchart.elements.earth': 'Earth',
    'birthchart.elements.air': 'Air',
    'birthchart.elements.water': 'Water',
    'birthchart.ficha.elemento': 'Element',
    'birthchart.ficha.polaridade': 'Polarity',
    'birthchart.ficha.modalidade': 'Modality',
    'birthchart.ficha.masculino': 'Masculine',
    'birthchart.ficha.feminino': 'Feminine',
    'birthchart.ficha.cardinal': 'Cardinal',
    'birthchart.ficha.fixo': 'Fixed',
    'birthchart.ficha.mutavel': 'Mutable',
    'birthchart.elements.reading.fogo':
...
const CHROME_MAPA_I18N = {
  pt: {
    ...
    'birthchart.header.subtitle': 'O céu que estava lá quando você chegou',
    ...
    // A FICHA EM TABELA (12/09/2026) — o recibo do instante deixou de ser uma
    // linha corrida ("09 de jan. de 1989 · 13:42 · UTC-02:00") e virou a tabela
    // rotulo/valor do print de referencia. Estes sao os rotulos da coluna da
    // esquerda; o valor e sempre dado do motor, nunca texto daqui.
    'birthchart.ficha.data': 'Data de nasc.',
    'birthchart.ficha.hora': 'Hora de nasc.',
    'birthchart.ficha.local': 'Local de nasc.',
    'birthchart.ficha.fuso': 'Fuso',
    // Convites honestos: aparecem APAGADOS no lugar do valor que falta, e o
    // toque abre o formulario. Nunca um traco mudo, nunca um valor chutado.
    'birthchart.ficha.convite.hora': 'adicione sua hora',
    'birthchart.ficha.convite.local': 'adicione sua cidade',
  ...
  es: {
    ...
    'birthchart.header.subtitle': 'El cielo que estaba ahí cuando llegaste',
    'birthchart.houseNumber': 'Casa {n}',
    'birthchart.housesNeed':
    ...
    'birthchart.ficha.data': 'Fecha de nac.',
    'birthchart.ficha.hora': 'Hora de nac.',
    'birthchart.ficha.local': 'Lugar de nac.',
    'birthchart.ficha.fuso': 'Huso horario',
    'birthchart.ficha.convite.hora': 'añade tu hora',
    'birthchart.ficha.convite.local': 'añade tu ciudad',
    'birthchart.couple.missingDate':
  ...
  en: {
    ...
    'birthchart.header.subtitle': 'The sky that was there when you arrived',
    ...
    'birthchart.ficha.data': 'Date of birth',
    'birthchart.ficha.hora': 'Time of birth',
    'birthchart.ficha.local': 'Place of birth',
    'birthchart.ficha.fuso': 'Time zone',
    'birthchart.ficha.convite.hora': 'add your time',
    'birthchart.ficha.convite.local': 'add your city',
    'birthchart.couple.missingDate':
...
const CHROME_COMPAT_I18N = {
  pt: {
    ...
    'compat.header.subtitle': 'O que acontece quando vocês dois se encontram',
  ...
  es: {
    ...
    'compat.header.subtitle': 'Lo que pasa cuando ustedes dos se encuentran',
  ...
  en: {
    ...
    'compat.header.subtitle': 'What happens when the two of you meet',
...
const PLANOS_I18N = {
  pt: {
    ...
    'planos.pill.top': 'Seu céu inteiro',
    'planos.pill.premium': 'Premium',
  },
  es: {
    'planos.badge.bestValue': 'MEJOR VALOR',
    'planos.trust': 'Cancela cuando quieras, directo en tu área de compras de Hotmart — el acceso sigue hasta el final del período ya pagado.',
    'planos.pill.top': 'Tu cielo entero',
    'planos.pill.premium': 'Premium',
  },
  en: {
    ...
    'planos.pill.top': 'Your whole sky',
    'planos.pill.premium': 'Premium',
  },
};
...
const ONBOARDING_I18N = {
  pt: {
    ...
    'onboarding.intro.focus': 'O que você não consegue parar de pensar hoje?',
    'onboarding.intro.name': 'Eu sou Órbi.',
    'onboarding.intro.promise': 'Me diga em três perguntas. Eu abro o céu do seu nascimento e começo por onde você mais precisa.',
    'onboarding.intro.control': 'Cada escolha muda o próximo passo. Você continua no controle.',
    'onboarding.intro.primary': 'Abrir meu céu',
    'onboarding.intro.shortcut': 'Já sei meu signo',
    'onboarding.intent.title': 'O que você quer entender agora?',
    'onboarding.intent.subtitle': 'Diga o que pesa mais agora e eu começo por aí. As cartas e os cálculos são os mesmos — a ordem é sua.',
    ...
    'onboarding.q.name.hint': 'Nenhuma leitura daqui vai falar com “você”. Vai falar com o seu nome.',
  ...
  es: {
    ...
    'onboarding.intro.focus': '¿En qué no dejas de pensar hoy?',
    'onboarding.intro.name': 'Soy Órbi.',
    'onboarding.intro.promise': 'Dímelo en tres preguntas. Abro el cielo de tu nacimiento y empiezo por donde más lo necesitas.',
    'onboarding.intro.control': 'Cada elección cambia el siguiente paso. Tú mantienes el control.',
    'onboarding.intro.primary': 'Abrir mi cielo',
    'onboarding.intro.shortcut': 'Ya sé mi signo',
    'onboarding.intent.title': '¿Qué quieres entender ahora?',
    'onboarding.intent.subtitle': 'Dime qué pesa más ahora y empiezo por ahí. Las cartas y los cálculos son los mismos — el orden es tuyo.',
    ...
    'onboarding.q.name.hint': 'Ninguna lectura de aquí va a hablarle a “ti”. Le va a hablar a tu nombre.',
  ...
  en: {
    ...
    'onboarding.intro.focus': 'What can’t you stop thinking about today?',
    'onboarding.intro.name': 'I’m Órbi.',
    'onboarding.intro.promise': 'Tell me in three questions. I open the sky you were born under and start where you need it most.',
    'onboarding.intro.control': 'Each choice changes what comes next. You stay in control.',
    'onboarding.intro.primary': 'Open my sky',
    'onboarding.intro.shortcut': 'I know my sign',
    'onboarding.intent.title': 'What do you want to understand now?',
    'onboarding.intent.subtitle': 'Tell me what weighs most right now and I start there. The cards and the math stay the same — the order is yours.',
    ...
    'onboarding.q.name.hint': 'No reading here will speak to “you”. It will speak to your name.',
...
const ORBI_I18N = {
  pt: {
    ...
    'orbi.chat.disclosure': 'Este espaço usa IA da Anthropic. Órbi não é pessoa nem consultor. Seu signo e as três escolhas acompanham a pergunta quando estão completos. Se você ativar a Memória Cósmica, até quatro frases anteriores relevantes também podem acompanhar; seu Diário e o histórico importado não são enviados.',
  ...
  es: {
    ...
    'orbi.chat.disclosure': 'Este espacio usa IA de Anthropic. Órbi no es una persona ni un consultor. Tu signo y las tres elecciones acompañan la pregunta cuando están completos. Si activas la Memoria Cósmica, también pueden acompañarla hasta cuatro frases anteriores relevantes; tu Diario y el historial importado no se envían.',
  ...
  en: {
    ...
    'orbi.chat.disclosure': 'This space uses Anthropic AI. Órbi is not a person or consultant. Your sign and all three choices travel with the question when complete. If you enable Cosmic Memory, up to four relevant sentences from earlier conversations may also travel with it; your Diary and imported history are not sent.',
...
const FUNIL_3S_I18N = {
  pt: {
    ...
    'home.explore.cta': 'Abrir o mapa completo',
  },
  es: {
    ...
    'home.explore.cta': 'Abrir el mapa completo',
  },
  en: {
    ...
    'home.explore.cta': 'Open the full map',
  },
};
...
const PLAY_STORE_I18N = {
  pt: {
    ...
    'planos.store.soonText': 'Tudo que você já usa continua aberto, de graça. Se você já assinou pelo site, entre com a mesma conta — seu acesso vem junto, em qualquer aparelho. Quando a assinatura abrir aqui dentro, ela aparece nesta tela.',
    'planos.store.loginCta': 'Entrar na minha conta',
    'planos.store.restore': 'Restaurar compras',
    'planos.store.restoreNone': 'Não achamos nenhuma assinatura ativa nesta conta do Google Play. Se você assinou com outra conta, entre com ela — o acesso está lá.',
  ...
  es: {
    ...
    'help.faq.cancel.answerStore': 'Cuando quieras, sin hablar con nadie. Si te suscribiste aquí por la app, quien cobra es Google Play: abre la Play Store, ve a Suscripciones, elige Cosmic Guide y toca cancelar. Si te suscribiste por el sitio, quien cobra es Hotmart: entra en tu área de compras con el correo que usaste, abre la suscripción de Cosmic Guide y toca cancelar. En los dos casos el acceso sigue hasta el final del período ya pagado.',
    ...
    'planos.store.soonTitle': 'La suscripción todavía no se abrió por aquí',
    'planos.store.soonText': 'Todo lo que ya usas sigue abierto, gratis. Si ya te suscribiste por el sitio, entra con la misma cuenta — tu acceso viene contigo, en cualquier dispositivo. Cuando la suscripción se abra aquí adentro, aparece en esta pantalla.',
    'planos.store.loginCta': 'Entrar en mi cuenta',
    'planos.store.restore': 'Restaurar compras',
    'planos.store.restoreNone': 'No encontramos ninguna suscripción activa en esta cuenta de Google Play. Si te suscribiste con otra cuenta, entra con ella — el acceso está ahí.',
    'planos.trustStore': 'Cancela cuando quieras en Play Store > Suscripciones — el acceso sigue hasta el final del período ya pagado.',
    'planos.legal.billingNoteStore': '¿Te suscribiste aquí por la app? El cobro es de Google Play y la cancelación es en Play Store > Suscripciones. ¿Te suscribiste por el sitio? El cobro es de Hotmart y la cancelación es en tu área de compras. En los dos casos se renueva solo al final de cada período y lo cancelas cuando quieras.',
  ...
  en: {
    ...
    'planos.store.soonText': 'Everything you already use stays open, for free. If you already subscribed on the website, sign in with the same account — your access comes with you, on any device. When subscriptions open inside the app, they show up on this screen.',
    'planos.store.loginCta': 'Sign in to my account',
    'planos.store.restore': 'Restore purchases',
    'planos.store.restoreNone': 'We found no active subscription on this Google Play account. If you subscribed with another account, sign in with that one — your access is there.',
...
const COMMUNITY_HUB_I18N = {
  pt: {
    ...
    'community.error.community_content_rejected': 'Esse texto não pode ser publicado porque pode conter ameaça, abuso, exploração sexual ou spam. Revise-o e tente novamente.',
  ...
  es: {
    ...
    'community.error.community_content_rejected': 'Este texto no puede publicarse porque puede contener amenazas, abuso, explotación sexual o spam. Revísalo e inténtalo de nuevo.',
  ...
  en: {
    ...
    'community.error.community_content_rejected': 'This text cannot be published because it may contain a threat, abuse, sexual exploitation, or spam. Review it and try again.',
...
// ---- Explorar · biblioteca permanente ----------------------------------
// A Home não carrega mais o catálogo inteiro. Esta cópia descreve a biblioteca
// e suas categorias; os nomes das experiências continuam vindo das chaves
// home.card.* já usadas nas entradas reais.
const EXPLORE_I18N = {
  pt: {
    'explore.back': 'Voltar para o início',
    'explore.topLabel': 'Todas as experiências',
    'explore.eyebrow': 'SEU MAPA DO COSMOS',
    'explore.title': 'Escolha o que você quer fazer.',
    'explore.body': 'Leituras, práticas e descobertas ficam reunidas aqui. A Home cuida do seu hoje; o catálogo completo mora em Explorar.',
    'explore.locked': 'CASAL PREMIUM',
    'explore.section.readings.eyebrow': 'PARA COMPREENDER',
    'explore.section.readings.title': 'Leituras pessoais',
    'explore.section.readings.subtitle': 'Comece por uma pergunta, pelo seu nascimento ou pelo que está vivendo agora.',
    'explore.section.practices.eyebrow': 'PARA FAZER',
    'explore.section.practices.title': 'Práticas e registro',
    'explore.section.practices.subtitle': 'Experiências com gesto, presença e memória pessoal.',
    'explore.section.sky.eyebrow': 'PARA ACOMPANHAR',
    'explore.section.sky.title': 'Céu e tempo',
    'explore.section.sky.subtitle': 'Datas calculadas, ciclos lunares e contexto histórico.',
    'explore.section.discoveries.eyebrow': 'PARA DESCOBRIR',
    'explore.section.discoveries.title': 'Histórias e curiosidades',
    'explore.section.discoveries.subtitle': 'Conteúdo para aprender, testar o que sabe e compartilhar.',
    'explore.section.couple.eyebrow': 'PARA DOIS',
    'explore.section.couple.title': 'Experiências de casal',
    'explore.section.couple.subtitle': 'Convide seu par para construir estas experiências juntos.',
  },
  es: {
    'explore.back': 'Volver al inicio',
    'explore.topLabel': 'Todas las experiencias',
    'explore.eyebrow': 'TU MAPA DEL COSMOS',
    'explore.title': 'Elige lo que quieres hacer.',
    'explore.body': 'Lecturas, prácticas y descubrimientos están reunidos aquí. El inicio cuida tu día; el catálogo completo vive en Explorar.',
    'explore.locked': 'PAREJA PREMIUM',
    'explore.section.readings.eyebrow': 'PARA COMPRENDER',
    'explore.section.readings.title': 'Lecturas personales',
    'explore.section.readings.subtitle': 'Empieza por una pregunta, por tu nacimiento o por lo que estás viviendo ahora.',
    'explore.section.practices.eyebrow': 'PARA HACER',
    'explore.section.practices.title': 'Prácticas y registro',
    'explore.section.practices.subtitle': 'Experiencias con gesto, presencia y memoria personal.',
    'explore.section.sky.eyebrow': 'PARA ACOMPAÑAR',
    'explore.section.sky.title': 'Cielo y tiempo',
    'explore.section.sky.subtitle': 'Fechas calculadas, ciclos lunares y contexto histórico.',
    'explore.section.discoveries.eyebrow': 'PARA DESCUBRIR',
    'explore.section.discoveries.title': 'Historias y curiosidades',
    'explore.section.discoveries.subtitle': 'Contenido para aprender, poner a prueba lo que sabes y compartir.',
    'explore.section.couple.eyebrow': 'PARA DOS',
    'explore.section.couple.title': 'Experiencias en pareja',
    'explore.section.couple.subtitle': 'Invita a tu pareja a construir estas experiencias juntos.',
  },
  en: {
    'explore.back': 'Back to Home',
    'explore.topLabel': 'Every experience',
    'explore.eyebrow': 'YOUR MAP OF THE COSMOS',
    'explore.title': 'Choose what you want to do.',
    'explore.body': 'Readings, practices, and discoveries live here. Home stays focused on today; the full library lives in Explore.',
    'explore.locked': 'PREMIUM COUPLE',
    'explore.section.readings.eyebrow': 'TO UNDERSTAND',
    'explore.section.readings.title': 'Personal readings',
    'explore.section.readings.subtitle': 'Begin with a question, your birth, or what you are living through now.',
    'explore.section.practices.eyebrow': 'TO DO',
    'explore.section.practices.title': 'Practices and reflection',
    'explore.section.practices.subtitle': 'Experiences shaped by gesture, presence, and personal memory.',
    'explore.section.sky.eyebrow': 'TO FOLLOW',
    'explore.section.sky.title': 'Sky and time',
    'explore.section.sky.subtitle': 'Calculated dates, lunar cycles, and historical context.',
    'explore.section.discoveries.eyebrow': 'TO DISCOVER',
    'explore.section.discoveries.title': 'Stories and curiosities',
    'explore.section.discoveries.subtitle': 'Content to learn from, test what you know, and share.',
    'explore.section.couple.eyebrow': 'FOR TWO',
    'explore.section.couple.title': 'Couple experiences',
    'explore.section.couple.subtitle': 'Invite your partner to build these experiences together.',
  },
};
Object.assign(PT, EXPLORE_I18N.pt);
Object.assign(ES, EXPLORE_I18N.es);
Object.assign(EN, EXPLORE_I18N.en);

// Descrições do catálogo Explorar. Diferente dos subtítulos curtos usados nos
// atalhos, estas frases dizem o que a pessoa realmente fará ao abrir cada
// experiência. O texto acompanha o comportamento atual das telas; não promete
// previsão, diagnóstico, foto na Linha do Tempo ou download nativo inexistente.
const EXPLORE_ITEM_DESCRIPTIONS_I18N = {
  pt: {
    'explore.item.horoscope.description': 'Compare ontem, hoje e amanhã com o céu calculado para o signo escolhido e consulte o método de cada bloco.',
    'explore.item.comovoceta.description': 'Escolha como você está agora e veja quais experiências do app conversam com esse momento.',
    'explore.item.birthchart.description': 'Use data, hora e cidade natal para calcular Sol, Lua, Ascendente, casas e aspectos; sem algum dado, parte fica indisponível.',
    'explore.item.tarot.description': 'Escolha tema, foco e tiragem; raspe três cartas e leia cada posição à luz da sua pergunta e, quando disponível, do seu signo.',
    'explore.item.compatibility.description': 'Compare dois signos em cinco áreas da vida e veja o aspecto tradicional usado na leitura.',
    'explore.item.dream.description': 'Descreva o sonho, responda a perguntas baseadas em Artemidoro e a uma pergunta do app, e peça uma leitura simbólica por IA.',
    'explore.item.palm.title': 'Leituras por imagem',
    'explore.item.palm.description': 'Envie uma foto da palma, do rosto, do pé ou de pintas para receber uma leitura simbólica por IA.',
    'explore.item.coffee.description': 'Fotografe a borra para uma leitura simbólica por IA; depois de sete leituras, veja um resumo do conjunto.',
    'explore.item.profeccoes.description': 'Use sua data de nascimento para calcular a casa, o senhor do ano e o período atual de 28 dias.',
    'explore.item.alignment.description': 'Arraste o céu atual sobre o mapa natal para revelar um aspecto próximo ou o próximo evento calculado.',
    'explore.item.grounding.description': 'Escolha um ritmo e uma duração para fazer alguns minutos de respiração contada e silêncio, com avisos de segurança.',
    'explore.item.rituais.description': 'Explore 21 práticas em sete objetivos e veja quais combinam com a fase da Lua e o dia da semana.',
    'explore.item.jornada.description': 'Escolha uma de quatro trilhas de sete dias, com leitura, pergunta e ação diária, ou inicie um Arco de 7 dias por convite.',
    'explore.item.diary.description': 'Releia, filtre, favorite e fixe leituras e reflexões guardadas; com registros recentes, gere um insight semanal por IA.',
    'explore.item.lunarCalendar.description': 'Veja a fase de hoje, as fases do mês e duas definições históricas de Lua fora de curso calculadas lado a lado.',
    'explore.item.calendario.description': 'Navegue por eventos do mês e pela temporada atual; com dados natais, veja até três trânsitos sobre o seu mapa.',
    'explore.item.zodiacbody.description': 'Conheça como fontes antigas ligavam signos e partes do corpo, com contexto histórico e sem orientação médica.',
    'explore.item.retrolua.description': 'Na Lua Cheia, reveja check-ins e leituras desde a Lua Nova; fora dela, veja quando a experiência estará disponível.',
    'explore.item.mitos.description': 'Compare 25 mitos populares com o que as fontes realmente dizem e veja a referência de cada correção.',
    'explore.item.quizcosmico.description': 'Responda a sete perguntas por dia e veja a explicação e a fonte logo após cada resposta.',
    'explore.item.wallpaper.description': 'Veja a arte 1080 × 1920 criada com o céu de hoje; na web, baixe o PNG para usar no celular.',
    'explore.item.idadereal.description': 'Compare quando cada ideia astrológica surgiu e veja quais ainda não têm data confirmada nas fontes.',
    'explore.item.social.description': 'Com login, publique e comente na praça ou em salas por signos solares, com regras, denúncia e bloqueio.',
    'explore.item.timeline.description': 'Registre memórias em texto e crie cápsulas do tempo com uma data futura de abertura.',
    'explore.item.reconectar.description': 'Escolha entre quatro trilhas de seis passos, receba uma sugestão com base nos quizzes ou use o modo SOS.',
    'explore.item.descobrir.description': 'Responda a quizzes de linguagem do amor e apego, mais duas perguntas sobre conflitos; os resultados ficam no aparelho.',
    'explore.item.agir.description': 'Encontre missões, ideias de encontro, um desafio de sete dias, o gesto do dia, uma meta semanal e sonhos do casal.',
    // As duas portas de casal (10/09/2026). A descrição NOMEIA as três telas
    // que cada uma reúne — quem procurava "Reconectar" precisa achar onde ela
    // foi parar, não concluir que sumiu.
    'explore.item.nosHoje.description': 'Agir, Reconectar e Descobrir num lugar só: missões, ideias de encontro, trilhas e os quizzes de vocês.',
    'explore.item.nossaHistoria.description': 'Linha do Tempo, Progresso e Retrospectiva: memórias, cápsulas, conquistas e o balanço do ano.',
    'explore.item.progresso.description': 'Veja sequência, conquistas e resumo mensal calculados somente a partir do que vocês registraram.',
    'explore.item.retrospectiva.description': 'Veja o total de memórias e cápsulas do ano, a maior sequência e o número de passos de reconexão registrados.',
  },
  es: {
    'explore.item.horoscope.description': 'Compara ayer, hoy y mañana con el cielo calculado para el signo elegido y consulta el método de cada bloque.',
    'explore.item.comovoceta.description': 'Elige cómo te sientes ahora y descubre qué experiencias de la app conectan con este momento.',
    'explore.item.birthchart.description': 'Usa fecha, hora y ciudad natal para calcular Sol, Luna, Ascendente, casas y aspectos; si falta algo, algunos no se calculan.',
    'explore.item.tarot.description': 'Elige tema, enfoque y tirada; raspa tres cartas y lee cada posición según tu pregunta y, cuando esté disponible, tu signo.',
    'explore.item.compatibility.description': 'Compara dos signos en cinco áreas de la vida y consulta el aspecto tradicional usado en la lectura.',
    'explore.item.dream.description': 'Describe el sueño, responde preguntas basadas en Artemidoro y una de la app, y solicita una lectura simbólica por IA.',
    'explore.item.palm.title': 'Lecturas por imagen',
    'explore.item.palm.description': 'Envía una foto de la palma, el rostro, el pie o los lunares para recibir una lectura simbólica por IA.',
    'explore.item.coffee.description': 'Fotografía los posos para una lectura simbólica por IA; después de siete lecturas, consulta un resumen del conjunto.',
    'explore.item.profeccoes.description': 'Usa tu fecha de nacimiento para calcular la casa, el señor del año y el período actual de 28 días.',
    'explore.item.alignment.description': 'Arrastra el cielo actual sobre tu carta natal para revelar un aspecto cercano o el próximo evento calculado.',
    'explore.item.grounding.description': 'Elige un ritmo y una duración para practicar unos minutos de respiración contada y silencio, con avisos de seguridad.',
    'explore.item.rituais.description': 'Explora 21 prácticas en siete objetivos y descubre cuáles coinciden con la fase lunar y el día de la semana.',
    'explore.item.jornada.description': 'Elige uno de cuatro senderos de siete días, con lectura, pregunta y acción diaria, o inicia un Arco de 7 días por invitación.',
    'explore.item.diary.description': 'Relee, filtra, marca como favoritas y fija lecturas y reflexiones; con registros recientes, genera un insight semanal por IA.',
    'explore.item.lunarCalendar.description': 'Consulta la fase de hoy, las fases del mes y dos definiciones históricas de Luna fuera de curso calculadas en paralelo.',
    'explore.item.calendario.description': 'Recorre los eventos del mes y la temporada actual; con datos natales, consulta hasta tres tránsitos sobre tu carta.',
    'explore.item.zodiacbody.description': 'Conoce cómo fuentes antiguas relacionaban signos y partes del cuerpo, con contexto histórico y sin orientación médica.',
    'explore.item.retrolua.description': 'En Luna Llena, revisa registros y lecturas desde la Luna Nueva; fuera de ella, consulta cuándo estará disponible.',
    'explore.item.mitos.description': 'Compara 25 mitos populares con lo que dicen las fuentes y consulta la referencia de cada corrección.',
    'explore.item.quizcosmico.description': 'Responde siete preguntas al día y consulta la explicación y la fuente después de cada respuesta.',
    'explore.item.wallpaper.description': 'Mira el diseño 1080 × 1920 creado con el cielo de hoy; en la web, descarga el PNG para usarlo en tu móvil.',
    'explore.item.idadereal.description': 'Compara cuándo surgió cada idea astrológica y descubre cuáles aún no tienen fecha confirmada en las fuentes.',
    'explore.item.social.description': 'Con inicio de sesión, publica y comenta en la plaza o en salas por signos solares, con normas, denuncia y bloqueo.',
    'explore.item.timeline.description': 'Registra recuerdos en texto y crea cápsulas del tiempo con una fecha futura de apertura.',
    'explore.item.reconectar.description': 'Elige entre cuatro caminos de seis pasos, recibe una sugerencia según los cuestionarios o usa el modo SOS.',
    'explore.item.descobrir.description': 'Explora lenguaje del amor, apego y conflictos con cuestionarios; guarda los resultados en tu dispositivo.',
    'explore.item.agir.description': 'Encuentra misiones, ideas para citas, un reto de siete días, el gesto del día, una meta semanal y sueños de pareja.',
    'explore.item.nosHoje.description': 'Actuar, Reconectar y Descubrir juntos: misiones, ideas para citas, rutas y los tests de ustedes.',
    'explore.item.nossaHistoria.description': 'Línea del Tiempo, Progreso y Retrospectiva: recuerdos, cápsulas, logros y el balance del año.',
    'explore.item.progresso.description': 'Consulta la racha, los logros y el resumen mensual calculados solo a partir de lo que registraron.',
    'explore.item.retrospectiva.description': 'Consulta el total de recuerdos y cápsulas del año, la mayor racha y el número de pasos de reconexión registrados.',
  },
  en: {
    'explore.item.horoscope.description': 'Compare yesterday, today, and tomorrow with sky data for your chosen sign, and review the method behind each section.',
    'explore.item.comovoceta.description': 'Choose how you feel right now and see which app experiences connect with this moment.',
    'explore.item.birthchart.description': 'Use birth date, time, and city to calculate Sun, Moon, Ascendant, houses, and aspects; missing data leaves some unavailable.',
    'explore.item.tarot.description': 'Choose a theme, focus, and spread; scratch three cards, then read each position for your question and sign when available.',
    'explore.item.compatibility.description': 'Compare two signs across five areas of life and see the traditional aspect used in the reading.',
    'explore.item.dream.description': 'Describe the dream, answer questions based on Artemidorus plus one from the app, then request an AI symbolic reading.',
    'explore.item.palm.title': 'Image Readings',
    'explore.item.palm.description': 'Send a photo of a palm, face, foot, or moles to receive an AI symbolic reading.',
    'explore.item.coffee.description': 'Photograph the coffee grounds for an AI symbolic reading; after seven readings, see a summary of the set.',
    'explore.item.profeccoes.description': 'Use your birth date to calculate the house, lord of the year, and current 28-day period.',
    'explore.item.alignment.description': 'Drag the current sky over your birth chart to reveal a close aspect or, if none is found, the next calculated event.',
    'explore.item.grounding.description': 'Choose a rhythm and duration for a few minutes of counted breathing and silence, with safety guidance.',
    'explore.item.rituais.description': 'Explore 21 practices across seven aims and see which match the Moon phase and day of the week.',
    'explore.item.jornada.description': 'Choose one of four seven-day trails with a daily reading, question, and action, or start a 7-day Arc from an invitation.',
    'explore.item.diary.description': 'Revisit, filter, favorite, and pin saved readings and reflections; with recent entries, generate a weekly AI insight.',
    'explore.item.lunarCalendar.description': "See today's phase, the month's phases, and two historical definitions of void-of-course Moon calculated side by side.",
    'explore.item.calendario.description': 'Browse the month’s events and current astrological season; with birth data, see up to three transits over your chart.',
    'explore.item.zodiacbody.description': 'Learn how historical sources linked signs and body parts, with context and no medical guidance.',
    'explore.item.retrolua.description': 'At the Full Moon, review check-ins and readings since the New Moon; otherwise, see when it will be available.',
    'explore.item.mitos.description': 'Compare 25 popular myths with what sources actually say and see the reference behind each correction.',
    'explore.item.quizcosmico.description': 'Answer seven questions a day and see the explanation and source immediately after each answer.',
    'explore.item.wallpaper.description': "Preview a 1080 × 1920 design made from today's sky; on the web, download the PNG for your phone.",
    'explore.item.idadereal.description': 'Compare when each astrological idea emerged and see which still lack a confirmed date in the sources.',
    'explore.item.social.description': 'Sign in to post and comment in the plaza or Sun-sign rooms, with community rules, reporting, and blocking.',
    'explore.item.timeline.description': 'Save text memories and create time capsules with a future date when they can be opened.',
    'explore.item.reconectar.description': 'Choose one of four six-step paths, get a suggestion based on the quizzes, or use SOS mode.',
    'explore.item.descobrir.description': 'Take love-language and attachment quizzes plus two conflict questions; results stay on this device.',
    'explore.item.agir.description': 'Find missions, date ideas, a seven-day challenge, the daily gesture, a weekly goal, and shared dreams.',
    'explore.item.nosHoje.description': 'Take Action, Reconnect and Discover in one place: missions, date ideas, tracks and your quizzes.',
    'explore.item.nossaHistoria.description': 'Timeline, Progress and Year in Review: memories, capsules, milestones and your year together.',
    'explore.item.progresso.description': 'See streaks, achievements, and a monthly summary calculated only from what you recorded.',
    'explore.item.retrospectiva.description': "See this year's totals for memories and capsules, the longest streak, and the number of recorded reconnection steps.",
  },
};
Object.assign(PT, EXPLORE_ITEM_DESCRIPTIONS_I18N.pt);
Object.assign(ES, EXPLORE_ITEM_DESCRIPTIONS_I18N.es);
Object.assign(EN, EXPLORE_ITEM_DESCRIPTIONS_I18N.en);

// Copy específica dos gates de casal. As chaves ficam no escopo do módulo para
// o HOC continuar estável sem congelar o idioma em português.
const COUPLE_GATE_I18N = {
  pt: {
    'gate.timeline.title': 'Linha do Tempo é pra fazer em casal',
    'gate.timeline.description': 'Guardem memórias e cápsulas do tempo juntos — chame seu par pra começarem a linha do tempo de vocês.',
    'gate.reconnect.title': 'Reconectar é pra fazer em casal',
    'gate.reconnect.description': 'Rotas guiadas de reconexão pro casal — chame seu par pra percorrerem juntos.',
    'gate.discover.title': 'Descobrir é pra fazer em casal',
    'gate.discover.description': 'Jogos e quizzes pra se conhecerem melhor — chame seu par pra jogarem juntos.',
    'gate.act.title': 'Agir é pra fazer em casal',
    'gate.act.description': 'Ideias de encontro e metas da semana pro casal — chame seu par pra colocarem em prática.',
    'gate.progress.title': 'Progresso é pra fazer em casal',
    'gate.progress.description': 'Acompanhem juntos a evolução da relação — chame seu par pra começarem.',
    'gate.recap.title': 'Retrospectiva é pra fazer em casal',
    'gate.recap.description': 'Revivam os melhores momentos juntos — chame seu par pra desbloquearem esta experiência.',
  },
  es: {
    'gate.timeline.title': 'La Línea del tiempo es para vivirla en pareja',
    'gate.timeline.description': 'Guarden recuerdos y cápsulas del tiempo juntos: invita a tu pareja para empezar su propia línea del tiempo.',
    'gate.reconnect.title': 'Reconectar es para hacerlo en pareja',
    'gate.reconnect.description': 'Rutas guiadas de reconexión: invita a tu pareja para recorrerlas juntos.',
    'gate.discover.title': 'Descubrir es para hacerlo en pareja',
    'gate.discover.description': 'Juegos y cuestionarios para conocerse mejor: invita a tu pareja para jugar juntos.',
    'gate.act.title': 'Actuar es para hacerlo en pareja',
    'gate.act.description': 'Ideas de citas y metas semanales: invita a tu pareja para llevarlas a la práctica.',
    'gate.progress.title': 'El Progreso es para vivirlo en pareja',
    'gate.progress.description': 'Acompañen juntos la evolución de la relación: invita a tu pareja para empezar.',
    'gate.recap.title': 'La Retrospectiva es para vivirla en pareja',
    'gate.recap.description': 'Revivan sus mejores momentos juntos: invita a tu pareja para desbloquear esta experiencia.',
  },
  en: {
    'gate.timeline.title': 'Timeline is made for couples',
    'gate.timeline.description': 'Save memories and time capsules together — invite your partner to start your shared timeline.',
    'gate.reconnect.title': 'Reconnect is made for couples',
    'gate.reconnect.description': 'Guided reconnection paths for two — invite your partner to walk through them together.',
    'gate.discover.title': 'Discover is made for couples',
    'gate.discover.description': 'Games and quizzes to know each other better — invite your partner to play together.',
    'gate.act.title': 'Act is made for couples',
    'gate.act.description': 'Date ideas and weekly goals for two — invite your partner to put them into practice.',
    'gate.progress.title': 'Progress is made for couples',
    'gate.progress.description': 'Follow your relationship’s growth together — invite your partner to begin.',
    'gate.recap.title': 'Recap is made for couples',
    'gate.recap.description': 'Relive your best moments together — invite your partner to unlock this experience.',
  },
};
Object.assign(PT, COUPLE_GATE_I18N.pt);
Object.assign(ES, COUPLE_GATE_I18N.es);
Object.assign(EN, COUPLE_GATE_I18N.en);

// Memória Cósmica — tratamento opcional e privado das mensagens NOVAS que a
// própria pessoa escreve ao Órbi. Estas chaves ficam no final para substituir
// a promessa antiga de que o backend nunca guardava conteúdo de conversa: ela
// continua verdadeira por padrão, mas deixa de ser quando há consentimento.
const COSMIC_MEMORY_PRIVACY_I18N = {
  pt: {
    'privacy.ai.chat': 'Mensagens da conversa com Órbi e, quando completos, seu signo e as três escolhas do primeiro caminho; se você ativar a Memória Cósmica, até quatro frases anteriores relevantes também podem acompanhar a pergunta (nunca o Diário nem o histórico importado)',
    'privacy.ai.memory': 'Memória Cósmica opcional: até 300 trechos de novas mensagens que você escreveu ao Órbi, visíveis e apagáveis no Perfil',
    'privacy.use.ai': 'Leituras de IA. A foto ou o texto que você envia — Palma, Rosto, Pé, Pintas, Café, Sonhos, Conversar com Órbi, Insight da Semana e a reflexão que você manda lapidar — passa pelo nosso servidor e é enviado à Anthropic, que gera a interpretação. Por padrão, nosso servidor não guarda o conteúdo da chamada: fica só a contagem diária. Na conversa com Órbi, o contexto permitido é descrito no próximo item. O tratamento feito pela Anthropic segue a política dela. Se você reportar uma resposta, a cópia denunciada também é guardada para moderação.',
    'privacy.use.memory': 'Memória Cósmica. Ela começa desligada. Quando você ativa em Perfil, nosso servidor pode guardar até 300 trechos de novas mensagens que você escrever ao Órbi, com até 1.600 caracteres cada. Até quatro lembranças relevantes, limitadas a 480 caracteres cada, podem seguir com uma pergunta futura para a Anthropic. Não guardamos nessa memória as respostas da IA, o Diário, os dados natais, a Comunidade nem o contexto de casal. Você vê e apaga cada item, apaga todos ou desativa o uso a qualquer momento. Desativar interrompe coleta e recuperação; apagar a conta remove conteúdo e consentimento.',
    'privacy.contact.retention': 'Para apagar sua CONTA, vá em Perfil > Deletar conta. Isso apaga o login no Supabase, desfaz o vínculo da assinatura e remove a Memória Cósmica e os dados da Comunidade ligados a você. Denúncias necessárias podem permanecer anonimizadas. O recibo do pagamento pode ser mantido por obrigação fiscal, sem vínculo com a conta; a contagem antiabuso permanece ligada somente ao UUID opaco de uma conta que já não existe. O Diário Cósmico continua neste aparelho até você apagar suas entradas. O botão vermelho abaixo limpa só este aparelho.',
    'profile.delete.text': 'Isso apaga de vez sua conta, o login, o vínculo da assinatura, toda a Memória Cósmica e os dados identificáveis da Comunidade, além dos dados locais cobertos pela limpeza deste aparelho. O Diário permanece até você apagar suas entradas. Denúncias necessárias podem ficar anonimizadas; recibo fiscal e contagem antiabuso podem permanecer sem vínculo com a conta. A cobrança não é cancelada: cancele antes no Google Play ou na Hotmart, conforme a compra.',
    'profile.delete.finalText': 'Última confirmação. Ao tocar em “Apagar de vez”, seu login, a Memória Cósmica e os dados identificáveis da Comunidade são removidos e não podem ser recuperados. O Diário continua neste aparelho; denúncias anonimizadas, recibo fiscal sem vínculo e contagem antiabuso podem permanecer pelos motivos descritos em Privacidade. A assinatura precisa ser cancelada separadamente.',
  },
  es: {
    'privacy.ai.chat': 'Mensajes de la conversación con Órbi y, cuando están completos, tu signo y las tres elecciones del primer camino; si activas la Memoria Cósmica, hasta cuatro frases anteriores relevantes también pueden acompañar la pregunta (nunca el Diario ni el historial importado)',
    'privacy.ai.memory': 'Memoria Cósmica opcional: hasta 300 fragmentos de mensajes nuevos que escribiste a Órbi, visibles y eliminables desde el Perfil',
    'privacy.use.ai': 'Lecturas de IA. La foto o el texto que envías — Palma, Rostro, Pie, Lunares, Café, Sueños, Conversar con Órbi, Insight Semanal y la reflexión que mandas pulir — pasa por nuestro servidor y se envía a Anthropic, que genera la interpretación. Por defecto, nuestro servidor no guarda el contenido de la llamada: solo queda el conteo diario. En la conversación con Órbi, el contexto permitido se describe en el siguiente punto. El tratamiento de Anthropic sigue su propia política. Si reportas una respuesta, la copia denunciada también se guarda para moderación.',
    'privacy.use.memory': 'Memoria Cósmica. Comienza desactivada. Cuando la activas en Perfil, nuestro servidor puede guardar hasta 300 fragmentos de mensajes nuevos que escribas a Órbi, de hasta 1.600 caracteres cada uno. Hasta cuatro recuerdos relevantes, limitados a 480 caracteres cada uno, pueden acompañar una pregunta futura enviada a Anthropic. No guardamos en esta memoria respuestas de la IA, el Diario, datos natales, la Comunidad ni el contexto de pareja. Puedes ver y borrar cada elemento, borrarlos todos o desactivar el uso en cualquier momento. Desactivarla detiene la recopilación y recuperación; eliminar la cuenta borra el contenido y el consentimiento.',
    'privacy.contact.retention': 'Para eliminar tu CUENTA, ve a Perfil > Eliminar cuenta. Eso borra el acceso en Supabase, deshace el vínculo de la suscripción y elimina la Memoria Cósmica y los datos de la Comunidad ligados a ti. Los reportes necesarios pueden permanecer anonimizados. El comprobante de pago puede conservarse por obligación fiscal, sin vínculo con la cuenta; el conteo antiabuso queda ligado solo al UUID opaco de una cuenta que ya no existe. El Diario Cósmico sigue en este dispositivo hasta que borres sus entradas. El botón rojo de abajo limpia solo este dispositivo.',
    'profile.delete.text': 'Esto elimina para siempre tu cuenta, el acceso, el vínculo de la suscripción, toda la Memoria Cósmica y los datos identificables de la Comunidad, además de los datos locales cubiertos por la limpieza de este dispositivo. El Diario permanece hasta que borres sus entradas. Los reportes necesarios pueden quedar anonimizados; el comprobante fiscal y el conteo antiabuso pueden permanecer sin vínculo con la cuenta. El cobro no se cancela: cancélalo antes en Google Play o Hotmart, según la compra.',
    'profile.delete.finalText': 'Última confirmación. Al tocar “Eliminar definitivamente”, se eliminan tu acceso, la Memoria Cósmica y los datos identificables de la Comunidad y no se pueden recuperar. El Diario sigue en este dispositivo; los reportes anonimizados, el comprobante fiscal sin vínculo y el conteo antiabuso pueden permanecer por los motivos descritos en Privacidad. La suscripción debe cancelarse por separado.',
  },
  en: {
    'privacy.ai.chat': 'Messages in the conversation with Órbi and, when complete, your sign and three first-path choices; if you enable Cosmic Memory, up to four relevant sentences from earlier conversations may also travel with the question (never your Diary or imported history)',
    'privacy.ai.memory': 'Optional Cosmic Memory: up to 300 excerpts from new messages you wrote to Órbi, visible and deletable from Profile',
    'privacy.use.ai': 'AI readings. The photo or text you send — Palm, Face, Foot, Moles, Coffee, Dreams, Talk with Órbi, Weekly Insight, and the reflection you ask us to polish — passes through our server and is sent to Anthropic, which generates the interpretation. By default, our server does not store the call content; only a daily count remains. The context allowed in an Órbi conversation is described in the next item. Anthropic handles data under its own policy. If you report a response, the reported copy is also stored for moderation.',
    'privacy.use.memory': 'Cosmic Memory. It starts disabled. When you enable it in Profile, our server may keep up to 300 excerpts from new messages you write to Órbi, up to 1,600 characters each. Up to four relevant memories, limited to 480 characters each, may accompany a future question sent to Anthropic. This memory does not store AI responses, your Diary, birth data, Community content, or couple context. You can view and delete each item, delete everything, or disable use at any time. Disabling stops collection and retrieval; deleting the account removes both content and consent.',
    'privacy.contact.retention': 'To delete your ACCOUNT, go to Profile > Delete account. This erases the Supabase login, unlinks the subscription, and removes Cosmic Memory and Community data linked to you. Reports that are still needed may remain anonymized. The payment receipt may be retained for tax obligations with no account link; the anti-abuse count remains tied only to the opaque UUID of an account that no longer exists. The Cosmic Diary stays on this device until you delete its entries. The red button below wipes only this device.',
    'profile.delete.text': 'This permanently deletes your account, login, subscription link, all Cosmic Memory, and identifiable Community data, along with the local data covered by this device wipe. The Diary remains until you delete its entries. Reports that are still needed may remain anonymized; the tax receipt and anti-abuse count may remain without an account link. Billing is not cancelled: cancel first through Google Play or Hotmart, depending on the purchase.',
    'profile.delete.finalText': 'Last confirmation. Tapping “Delete permanently” removes your login, Cosmic Memory, and identifiable Community data, and they cannot be recovered. The Diary stays on this device; anonymized reports, an unlinked tax receipt, and the anti-abuse count may remain for the reasons described in Privacy. The subscription must be cancelled separately.',
  },
};
Object.assign(PT, COSMIC_MEMORY_PRIVACY_I18N.pt);
Object.assign(ES, COSMIC_MEMORY_PRIVACY_I18N.es);
Object.assign(EN, COSMIC_MEMORY_PRIVACY_I18N.en);
