...
const PT = {
  ...
  'tarot.subtitle': 'Tarô que não doura a pílula — Passado · Presente · Futuro',
  'tarot.album': 'Álbum',
  'tarot.tap': 'Toque',
...
const PAYWALL_I18N = {
  pt: {
    ...
    'onetimelock.freeUsed.text.couple': 'Da segunda em diante é com assinatura: as nove leituras individuais, mais as telas de vocês dois, sem limite — e cada afirmação com a fonte de onde veio.',
    'onetimelock.freeUsed.text.solo': 'Da segunda em diante é com assinatura: as nove leituras individuais sem limite — e cada afirmação com a fonte de onde veio, obra, autor e século.',
  ...
  es: {
    ...
    'onetimelock.freeUsed.text.couple': 'De la segunda en adelante va con suscripción: las nueve lecturas individuales, más las pantallas de los dos, sin límite — y cada afirmación con la fuente de donde salió.',
    'onetimelock.freeUsed.text.solo': 'De la segunda en adelante va con suscripción: las nueve lecturas individuales sin límite — y cada afirmación con la fuente de donde salió: obra, autor y siglo.',
  ...
  en: {
    ...
    'onetimelock.freeUsed.text.couple': 'From the second one on it takes a subscription: the nine individual readings, plus the screens for the two of you, with no limit — and every claim with the source it came from.',
    'onetimelock.freeUsed.text.solo': 'From the second one on it takes a subscription: the nine individual readings with no limit — and every claim with the source it came from: work, author and century.',
...
// slides reusam birthchart.positionIn + birthchart.row.*.desc/missing, os
// mesmos textos que o Mapa Astral já mostra (regra: nunca escrever leitura
// nova). Tom de convite, zero promessa de efeito — a única "promessa" aqui é
...
const PLAY_STORE_I18N = {
  pt: {
    ...
    'profile.delete.partialText': 'Sua conta e os dados deste aparelho foram apagados. Alguns dados ligados à sua assinatura podem não ter saído do nosso servidor agora — se quiser confirmação, escreva pra contato@cosmicguide.cloud.',
    'report.cta': 'Reportar esta resposta',
    'report.title': 'Reportar esta resposta',
    'report.body': 'Esta resposta foi gerada por IA. Escolha o motivo — a resposta que você está reportando é enviada pra revisão. Nada do que você escreveu vai junto.',
    ...
    'privacy.use.ai': 'Leituras de IA. A foto ou o texto que você envia — Palma, Rosto, Pé, Pintas, Café, Sonhos, Chat, Insight da Semana e a reflexão que você manda lapidar — vai para o nosso servidor e é processado por um serviço de IA de terceiros (Anthropic) só na hora de gerar aquela interpretação. Não fica guardado depois que a resposta é gerada.',
    ...
    'privacy.contact.retention': 'Para apagar a sua CONTA de login e o vínculo da assinatura, vá em Perfil > Deletar conta: lá a exclusão acontece de verdade, no nosso servidor e no Supabase. O botão vermelho abaixo limpa só este aparelho.',
    'privacy.delete.message': 'Isso apaga para sempre, neste aparelho, os nomes, signos, datas e horas de nascimento, a cidade e a sequência salva — e apaga também, no nosso servidor, o histórico anônimo de passos deste aparelho e a inscrição do lembrete diário. NÃO saem por aqui: o que está no Diário Cósmico (cada entrada é apagada dentro do próprio Diário), a sua conta de login, o registro da sua assinatura e o que você publicou no feed social — para esses, use Perfil > Deletar conta e o próprio feed. Essa ação não pode ser desfeita.',
    'privacy.local.title': 'O que fica guardado neste aparelho',
    'privacy.local.names': 'Nomes de vocês dois (ou só o seu, no modo solo)',
    ...
    'privacy.ai.chat': 'Mensagens da conversa (Chat Espiritual)',
    ...
    'help.faq.readings.answer': 'As leituras que você salva ficam no Diário Cósmico, neste aparelho, junto com os dados de nascimento. As fotos e os textos que você manda para as leituras de IA (Palma, Rosto, Pé, Pintas, Café, Sonhos, Chat e Lapidar) vão para o nosso servidor e para um serviço de IA de terceiros só na hora de gerar a resposta, e não ficam guardados depois. Já o que você publica no feed social fica no nosso servidor e é visível para os outros usuários. A lista completa está em Perfil > Privacidade.',
    ...
    'social.mod.blockedBody': 'Nada dela aparece mais pra você por aqui.',
    'social.mod.undo': 'Desfazer',
  ...
  es: {
    ...
    'profile.delete.partialText': 'Tu cuenta y los datos de este dispositivo fueron borrados. Puede que algunos datos ligados a tu suscripción no hayan salido de nuestro servidor ahora mismo — si quieres confirmación, escribe a contato@cosmicguide.cloud.',
    'report.cta': 'Reportar esta respuesta',
    'report.title': 'Reportar esta respuesta',
    'report.body': 'Esta respuesta fue generada por IA. Elige el motivo — la respuesta que estás reportando se envía para revisión. Nada de lo que escribiste va con ella.',
    ...
    'privacy.use.ai': 'Lecturas de IA. La foto o el texto que envías — Palma, Rostro, Pie, Lunares, Café, Sueños, Chat, Insight de la Semana y la reflexión que mandas pulir — va a nuestro servidor y lo procesa un servicio de IA de terceros (Anthropic) solo en el momento de generar esa interpretación. No queda guardado después de que la respuesta se genera.',
    ...
    'privacy.contact.retention': 'Para eliminar tu CUENTA de acceso y el vínculo de la suscripción, ve a Perfil > Eliminar cuenta: ahí la eliminación ocurre de verdad, en nuestro servidor y en Supabase. El botón rojo de abajo limpia solo este dispositivo.',
    'privacy.delete.message': 'Esto borra para siempre, en este dispositivo, los nombres, signos, fechas y horas de nacimiento, la ciudad y la racha guardada — y borra también, en nuestro servidor, el historial anónimo de pasos de este dispositivo y la suscripción del recordatorio diario. NO se van por aquí: lo que está en el Diario Cósmico (cada entrada se borra dentro del propio Diario), tu cuenta de acceso, el registro de tu suscripción y lo que publicaste en el feed social — para eso, usa Perfil > Eliminar cuenta y el propio feed. Esta acción no se puede deshacer.',
    'privacy.local.title': 'Lo que queda guardado en este dispositivo',
    'privacy.local.names': 'Los nombres de ustedes dos (o solo el tuyo, en modo individual)',
    ...
    'privacy.ai.chat': 'Los mensajes de la conversación (Chat Espiritual)',
    ...
    'help.faq.readings.answer': 'Las lecturas que guardas quedan en el Diario Cósmico, en este dispositivo, junto con los datos de nacimiento. Las fotos y los textos que mandas a las lecturas de IA (Palma, Rostro, Pie, Lunares, Café, Sueños, Chat y Pulir) van a nuestro servidor y a un servicio de IA de terceros solo en el momento de generar la respuesta, y no quedan guardados después. En cambio, lo que publicas en el feed social queda en nuestro servidor y es visible para los demás usuarios. La lista completa está en Perfil > Privacidad.',
    ...
    'social.mod.blockedBody': 'Ya no verás nada de ella por aquí.',
    'social.mod.undo': 'Deshacer',
  ...
  en: {
    ...
    'profile.delete.partialText': "Your account and this device's data were deleted. Some data tied to your subscription may not have left our server just now — if you want confirmation, write to contato@cosmicguide.cloud.",
    'report.cta': 'Report this response',
    'report.title': 'Report this response',
    'report.body': 'This response was generated by AI. Pick a reason — the response you are reporting is sent for review. Nothing you wrote goes with it.',
    ...
    'privacy.use.ai': 'AI readings. The photo or text you send — Palm, Face, Foot, Moles, Coffee, Dreams, Chat, Weekly Insight and the reflection you ask us to polish — goes to our server and is processed by a third-party AI service (Anthropic) only at the moment that interpretation is generated. It is not kept once the answer comes back.',
    ...
    'privacy.contact.retention': 'To delete your login ACCOUNT and the subscription link, go to Profile > Delete account: that is where the deletion really happens, on our server and on Supabase. The red button below only wipes this device.',
    'privacy.delete.message': "This permanently erases, on this device, the names, signs, birth dates and times, the city and the saved streak — and also erases, on our server, this device's anonymous history of steps and the daily reminder subscription. These do NOT go away here: whatever is in the Cosmic Diary (each entry is deleted from inside the Diary itself), your login account, your subscription record and anything you posted in the social feed — for those, use Profile > Delete account and the feed itself. This action cannot be undone.",
    'privacy.local.title': 'What stays on this device',
    'privacy.local.names': 'Both your names (or just yours, in solo mode)',
    ...
    'privacy.ai.chat': 'The messages in the conversation (Spiritual Chat)',
    ...
    'help.faq.readings.answer': 'The readings you save stay in the Cosmic Diary, on this device, together with your birth details. The photos and text you send for AI readings (Palm, Face, Foot, Moles, Coffee, Dreams, Chat and Polish) go to our server and to a third-party AI service only while the answer is being generated, and are not kept afterwards. What you post in the social feed, on the other hand, stays on our server and is visible to other users. The full list is in Profile > Privacy.',
    ...
    'social.mod.blockedBody': 'Nothing from them shows up here anymore.',
    'social.mod.undo': 'Undo',
