...
const SOM_DO_CEU = {
  pt: {
    ...
    'sound.tagline':
      'Som ambiente que nasce do céu de hoje — tradição e companhia pra deixar tocando enquanto você lê. Sem promessa de efeito nenhum.',
    'sound.play': 'Tocar',
    'sound.pause': 'Pausar',
    ...
    'sound.disclaimer':
      'Frequências aqui são escolha de ambiente, dentro de uma tradição simbólica sem confirmação científica — e sem qualquer promessa de efeito sobre você.',
  ...
  es: {
    ...
    'sound.tagline':
      'Sonido ambiente que nace del cielo de hoy — tradición y compañía para dejar sonando mientras leés. Sin ninguna promesa de efecto.',
    ...
    'sound.disclaimer':
      'Las frecuencias acá son una elección de ambiente, dentro de una tradición simbólica sin confirmación científica — y sin ninguna promesa de efecto sobre vos.',
  ...
  en: {
    ...
    'sound.tagline':
      'Ambient sound built from today’s sky — tradition and company to leave playing while you read. No promise of any effect.',
    'sound.play': 'Play',
    'sound.pause': 'Pause',
    ...
    'sound.disclaimer':
      'Frequencies here are an ambience choice inside a symbolic tradition with no scientific backing — and no promise of any effect on you.',
    'sound.timer': 'Stop in',
    'sound.timer.minutes': '{n} min',
...
const ZODIAC_BODY_I18N = {
  pt: {
    ...
    'zodiacBody.moon.part': 'Na lista de Manílio, {sign} respondia por: {part}.',
    ...
    'zodiacBody.sun.body': 'Na enumeração de Manílio, {sign} aparece com: {part}.',
    'zodiacBody.sun.caveat':
      'Uma ressalva que muda tudo: a tradição não lia o corpo pelo signo de nascimento. A melotesia trabalhava com a posição da LUA no instante do procedimento, e o signo solar como identidade pessoal é invenção da imprensa popular do século XX, das colunas de jornal a partir dos anos 1930. Esta linha é curiosidade sobre a lista antiga, não uma leitura sobre você.',
    'zodiacBody.sun.none':
    ...
    'zodiacBody.entry.flagLateLayer': 'a versão popular desta é camada tardia',
    ...
    'zodiacBody.planets.intro':
      'Esta é a lista que Ptolomeu de fato enumera: a dos planetas. A dos doze signos é de Manílio. Atribuir a lista Áries-cabeça ao Tetrabiblos é erro corrente, inclusive em textos que se apresentam como sérios — Ptolomeu pressupõe a correspondência entre signo e parte do corpo, mas em nenhum momento a escreve.',
    'zodiacBody.planets.qualities':
      'Em Tetrabiblos I.iv, Ptolomeu descrevia as qualidades elementares de cada planeta: o Sol, calor e secura moderada; a Lua, sobretudo umidade; Saturno, frio e secura, mais eficaz no frio que na secura; Marte, secura e forte calor; Júpiter, calor e umidade temperados; Vênus, temperada e mais úmida que quente; Mercúrio, ora seco, ora úmido. Em I.v, classificava calor e umidade como nutritivos e secura e frio como destrutivos — daí Júpiter, Vênus e a Lua benéficos, Saturno e Marte maléficos, Sol e Mercúrio comuns.',
    'zodiacBody.planets.humours':
      'Ressalva metodológica: em nenhum destes capítulos Ptolomeu nomeia os quatro humores galênicos mapeados um a um em planetas. O mapa fechado que se repete por aí — Júpiter sanguíneo, Marte colérico, Saturno melancólico, Lua e Vênus fleumáticos — é síntese medieval e renascentista, feita cruzando Galeno com o Tetrabiblos. Que a síntese existiu e circulou, disso não há dúvida; atribuí-la a um autor antigo específico é que não se sustenta.',
    ...
    'zodiacBody.history.origin.body':
      'A enumeração dos doze signos sobre o corpo, da cabeça aos pés, aparece em Manílio, no poema Astronomica, no século I d.C. É a atestação canônica mais antiga em texto contínuo conservado, e é dela que sai tudo o que veio depois.',
    'zodiacBody.history.precursor.title': 'Um precursor mesopotâmico',
    'zodiacBody.history.precursor.body':
      'Existe um antecedente cuneiforme, babilônio tardio, com uma lista quase idêntica de divisões corporais, publicado por John Z. Wee em 2015. Vale registrar que ele existe. Não vale dizer «tradição de 5.000 anos»: a datação da tábua é incerta, não há elo egípcio comprovado, e o que se documenta são cerca de dois mil anos de tradição textual.',
    'zodiacBody.history.image.title': 'A imagem que todo mundo já viu',
    'zodiacBody.history.image.body':
      'A miniatura do «Homme anatomique», nas Très Riches Heures do Duque de Berry, é descrita pela literatura como iconografia rara em manuscrito iluminado: dois corpos nus dorso a dorso, com os doze signos sobre as regiões correspondentes.',
    ...
    'zodiacBody.history.rule.body':
      'O preceito central não vem de Ptolomeu, e este é o ponto que mais se erra por aí. Ele é o aforismo 20 do Centiloquium, coleção de cem aforismos atribuída a Ptolomeu por toda a Idade Média e a Idade Moderna, mas pseudoepigráfica: Richard Lemay argumentou que a obra é de Abu Jaʿfar Ahmad ibn Yusuf, astrólogo árabe do século X — tese dele, não consenso fechado —, e a primeira tradução latina completa é de Barcelona, 1136. Os aforismos vizinhos formavam um bloco inteiro de regras de calendário terapêutico.',
    ...
    'zodiacBody.history.plague.body':
      'O caso documental mais forte é o Compendium de epidemia, redigido pela Faculdade de Medicina de Paris em outubro de 1348 a pedido de Filipe VI: ele explicava a Peste Negra por uma conjunção de Saturno, Júpiter e Marte em Aquário, ocorrida «uma hora depois do meio-dia de 20 de março de 1345».',
    'zodiacBody.history.exit.title': 'Como saiu da medicina',
    'zodiacBody.history.exit.body':
      'Não houve decreto único: houve erosão. A Fabrica de Vesalius, em 1543, e o De motu cordis de Harvey, em 1628, deslocaram a autoridade para a dissecação e a observação, e no século XVII os médicos universitários passaram a invocar influência celeste cada vez mais raramente. A literatura acadêmica recente insiste que não existe ponto único de rejeição formal: ao fim do século XVII a iatromatemática já não era ensinada, mas ainda era praticada em 1700 «widely and lucratively» — o que mudou primeiro foi o registro social, de controvérsia para ridículo. Resíduos institucionais duraram muito: os titulares das cátedras de astronomia de Salamanca e de Bolonha ainda eram obrigados a produzir almanaques astrológicos para os estudantes de medicina até 1770 e 1799. Bulas papais condenaram a astrologia judiciária em 1586 e em 1631 — estas duas datas ficam com confiança média, seus textos não foram reconferidos nesta pesquisa.',
    ...
    'zodiacBody.culpeper.method':
      'O verbete da losna é onde ele expõe abertamente como decidia a regência de uma planta. Não é revelação nenhuma: é um silogismo escolástico, e o argumento é o LUGAR onde a planta cresce.',
    ...
    'zodiacBody.modern.intro':
      'Muita coisa que hoje se apresenta como «tradição antiga» tem cerca de cem anos e entrou pela literatura teosófica e rosacruz do século XX — Heinrich Daath (Medical Astrology, manual n.º 9 da série de Alan Leo, 1914), Max e Augusta Foss Heindel (1929), H. L. Cornell (1933). Nada disto está em Manílio nem em Ptolomeu:',
  ...
  es: {
    ...
    'zodiacBody.moon.part': 'En la lista de Manilio, {sign} respondía por: {part}.',
    ...
    'zodiacBody.sun.body': 'En la enumeración de Manilio, {sign} aparece con: {part}.',
    'zodiacBody.sun.caveat':
      'Una salvedad que lo cambia todo: la tradición no leía el cuerpo por el signo de nacimiento. La melotesia trabajaba con la posición de la LUNA en el instante del procedimiento, y el signo solar como identidad personal es invención de la prensa popular del siglo XX, de las columnas de diario a partir de los años treinta. Esta línea es curiosidad sobre la lista antigua, no una lectura sobre vos.',
    'zodiacBody.sun.none':
    ...
    'zodiacBody.entry.flagLateLayer': 'la versión popular de esta es capa tardía',
    'zodiacBody.confidence.media':
    ...
    'zodiacBody.planets.intro':
      'Esta es la lista que Ptolomeo enumera de verdad: la de los planetas. La de los doce signos es de Manilio. Atribuir la lista Aries-cabeza al Tetrabiblos es un error corriente, incluso en textos que se presentan como serios: Ptolomeo presupone la correspondencia entre signo y parte del cuerpo, pero en ningún momento la escribe.',
    'zodiacBody.planets.qualities':
      'En Tetrabiblos I.iv, Ptolomeo describía las cualidades elementales de cada planeta: el Sol, calor y sequedad moderada; la Luna, sobre todo humedad; Saturno, frío y sequedad, más eficaz en el frío que en la sequedad; Marte, sequedad y fuerte calor; Júpiter, calor y humedad templados; Venus, templada y más húmeda que caliente; Mercurio, ya seco, ya húmedo. En I.v clasificaba calor y humedad como nutritivos, y sequedad y frío como destructivos: de ahí Júpiter, Venus y la Luna benéficos, Saturno y Marte maléficos, Sol y Mercurio comunes.',
    'zodiacBody.planets.humours':
      'Salvedad metodológica: en ninguno de estos capítulos Ptolomeo nombra los cuatro humores galénicos mapeados uno a uno en planetas. El mapa cerrado que se repite por ahí — Júpiter sanguíneo, Marte colérico, Saturno melancólico, Luna y Venus flemáticos — es una síntesis medieval y renacentista, hecha cruzando a Galeno con el Tetrabiblos. Que la síntesis existió y circuló no está en duda; lo que no se sostiene es atribuirla a un autor antiguo concreto.',
    ...
    'zodiacBody.history.origin.body':
      'La enumeración de los doce signos sobre el cuerpo, de la cabeza a los pies, aparece en Manilio, en el poema Astronomica, en el siglo I d. C. Es la atestación canónica más antigua en texto continuo conservado, y de ella sale todo lo que vino después.',
    'zodiacBody.history.precursor.title': 'Un precursor mesopotámico',
    'zodiacBody.history.precursor.body':
      'Existe un antecedente cuneiforme, babilonio tardío, con una lista casi idéntica de divisiones corporales, publicado por John Z. Wee en 2015. Vale registrar que existe. No vale decir «tradición de 5.000 años»: la datación de la tablilla es incierta, no hay vínculo egipcio comprobado, y lo que se documenta son unos dos mil años de tradición textual.',
    'zodiacBody.history.image.title': 'La imagen que todo el mundo ya vio',
    'zodiacBody.history.image.body':
      'La miniatura del «Homme anatomique», en las Très Riches Heures del Duque de Berry, es descrita por la literatura como iconografía rara en manuscrito iluminado: dos cuerpos desnudos espalda contra espalda, con los doce signos sobre las regiones correspondientes.',
    ...
    'zodiacBody.history.rule.body':
      'El precepto central no viene de Ptolomeo, y este es el punto en el que más se falla. Es el aforismo 20 del Centiloquium, colección de cien aforismos atribuida a Ptolomeo durante toda la Edad Media y la Edad Moderna, pero pseudoepigráfica: Richard Lemay argumentó que la obra es de Abu Jaʿfar Ahmad ibn Yusuf, astrólogo árabe del siglo X — tesis suya, no consenso cerrado —, y la primera traducción latina completa es de Barcelona, 1136. Los aforismos vecinos formaban todo un bloque de reglas de calendario terapéutico.',
    ...
    'zodiacBody.history.plague.body':
      'El caso documental más fuerte es el Compendium de epidemia, redactado por la Facultad de Medicina de París en octubre de 1348 a pedido de Felipe VI: explicaba la Peste Negra por una conjunción de Saturno, Júpiter y Marte en Acuario, ocurrida «una hora después del mediodía del 20 de marzo de 1345».',
    'zodiacBody.history.exit.title': 'Cómo salió de la medicina',
    'zodiacBody.history.exit.body':
      'No hubo un decreto único: hubo erosión. La Fabrica de Vesalio, en 1543, y el De motu cordis de Harvey, en 1628, desplazaron la autoridad hacia la disección y la observación, y en el siglo XVII los médicos universitarios pasaron a invocar la influencia celeste cada vez con menos frecuencia. La literatura académica reciente insiste en que no existe un punto único de rechazo formal: a fines del siglo XVII la iatromatemática ya no se enseñaba, pero todavía se practicaba en 1700 «widely and lucratively»; lo que cambió primero fue el registro social, de controversia a ridículo. Los residuos institucionales duraron mucho: los titulares de las cátedras de astronomía de Salamanca y de Bolonia todavía estaban obligados a producir almanaques astrológicos para los estudiantes de medicina hasta 1770 y 1799. Bulas papales condenaron la astrología judiciaria en 1586 y en 1631 — estas dos fechas quedan con confianza media, sus textos no fueron reverificados en esta investigación.',
    ...
    'zodiacBody.culpeper.method':
      'La entrada del ajenjo es donde expone abiertamente cómo decidía la regencia de una planta. No es ninguna revelación: es un silogismo escolástico, y el argumento es el LUGAR donde la planta crece.',
    'zodiacBody.culpeper.chain':
    ...
    'zodiacBody.modern.intro':
      'Mucho de lo que hoy se presenta como «tradición antigua» tiene unos cien años y entró por la literatura teosófica y rosacruz del siglo XX: Heinrich Daath (Medical Astrology, manual n.º 9 de la serie de Alan Leo, 1914), Max y Augusta Foss Heindel (1929), H. L. Cornell (1933). Nada de esto está en Manilio ni en Ptolomeo:',
    'zodiacBody.modern.glands':
  ...
  en: {
    ...
    'zodiacBody.moon.part': 'In Manilius’s list, {sign} answered for: {part}.',
    ...
    'zodiacBody.sun.body': 'In Manilius’s enumeration, {sign} appears with: {part}.',
    'zodiacBody.sun.caveat':
      'One caveat changes everything: the tradition did not read the body from the birth sign. Melothesia worked with the position of the MOON at the moment of the procedure, and the sun sign as personal identity is an invention of the 20th-century popular press, of newspaper columns from the 1930s on. This line is a curiosity about the old list, not a reading about you.',
    'zodiacBody.sun.none':
    ...
    'zodiacBody.entry.flagLateLayer': 'the popular version of this one is a late layer',
    'zodiacBody.confidence.media':
    ...
    'zodiacBody.planets.intro':
      'This is the list Ptolemy actually enumerates: the planetary one. The list of the twelve signs is Manilius’s. Crediting the Aries-head list to the Tetrabiblos is a common error, including in texts that present themselves as serious — Ptolemy presupposes the sign-to-body correspondence but never writes it out.',
    'zodiacBody.planets.qualities':
      'In Tetrabiblos I.iv, Ptolemy described the elemental qualities of each planet: the Sun, heat and moderate dryness; the Moon, chiefly moisture; Saturn, cold and dryness, more effective in cold than in dryness; Mars, dryness and strong heat; Jupiter, tempered heat and moisture; Venus, temperate and more moist than hot; Mercury, now dry, now moist. In I.v he classed heat and moisture as nutritive and dryness and cold as destructive — hence Jupiter, Venus and the Moon as benefics, Saturn and Mars as malefics, the Sun and Mercury as common.',
    'zodiacBody.planets.humours':
      'A methodological caveat: in none of these chapters does Ptolemy name the four Galenic humours mapped one to one onto planets. The closed map that circulates everywhere — Jupiter sanguine, Mars choleric, Saturn melancholic, Moon and Venus phlegmatic — is a medieval and Renaissance synthesis, made by crossing Galen with the Tetrabiblos. That the synthesis existed and circulated is not in doubt; what does not hold is crediting it to one specific ancient author.',
    ...
    'zodiacBody.history.origin.body':
      'The enumeration of the twelve signs over the body, head to feet, appears in Manilius, in the poem Astronomica, in the 1st century AD. It is the oldest canonical attestation in continuous surviving text, and everything that came later comes out of it.',
    'zodiacBody.history.precursor.title': 'A Mesopotamian precursor',
    'zodiacBody.history.precursor.body':
      'There is a cuneiform antecedent, late Babylonian, with an almost identical list of bodily divisions, published by John Z. Wee in 2015. It is worth recording that it exists. It is not worth saying «a 5,000-year tradition»: the tablet’s dating is uncertain, there is no proven Egyptian link, and what is documented is roughly two thousand years of textual tradition.',
    'zodiacBody.history.image.title': 'The image everyone has already seen',
    'zodiacBody.history.image.body':
      'The «Homme anatomique» miniature, in the Très Riches Heures of the Duke of Berry, is described in the literature as rare iconography in an illuminated manuscript: two naked bodies back to back, with the twelve signs over the corresponding regions.',
    ...
    'zodiacBody.history.rule.body':
      'The central precept does not come from Ptolemy, and this is the point most often got wrong. It is aphorism 20 of the Centiloquium, a collection of one hundred aphorisms credited to Ptolemy throughout the Middle Ages and the early modern period, but pseudepigraphic: Richard Lemay argued the work is by Abu Jaʿfar Ahmad ibn Yusuf, a 10th-century Arab astrologer — his thesis, not settled consensus — and the first complete Latin translation is from Barcelona, 1136. The neighbouring aphorisms formed a whole block of therapeutic-calendar rules.',
    ...
    'zodiacBody.history.plague.body':
      'The strongest documentary case is the Compendium de epidemia, written by the Paris Medical Faculty in October 1348 at the request of Philip VI: it explained the Black Death by a conjunction of Saturn, Jupiter and Mars in Aquarius, «at one hour after noon on 20 March 1345».',
    'zodiacBody.history.exit.title': 'How it left medicine',
    'zodiacBody.history.exit.body':
      'There was no single decree: there was erosion. Vesalius’s Fabrica, in 1543, and Harvey’s De motu cordis, in 1628, moved authority towards dissection and observation, and in the 17th century university physicians invoked celestial influence ever more rarely. Recent scholarship insists there is no single point of formal rejection: by the end of the 17th century iatromathematics was no longer taught, yet it was still practised in 1700 «widely and lucratively» — what changed first was the social register, from controversy to ridicule. Institutional residues lasted a long time: the holders of the astronomy chairs at Salamanca and Bologna were still required to produce astrological almanacs for medical students until 1770 and 1799. Papal bulls condemned judicial astrology in 1586 and 1631 — those two dates carry medium confidence here, their texts were not re-checked in this research.',
    ...
    'zodiacBody.culpeper.method':
      'The wormwood entry is where he sets out openly how he decided a plant’s rulership. It is no revelation: it is a scholastic syllogism, and the argument is the PLACE where the plant grows.',
    'zodiacBody.culpeper.chain':
    ...
    'zodiacBody.modern.intro':
      'A great deal of what is presented today as «ancient tradition» is about a hundred years old and came in through the theosophical and Rosicrucian literature of the 20th century: Heinrich Daath (Medical Astrology, no. 9 in the Alan Leo series of manuals, 1914), Max and Augusta Foss Heindel (1929), H. L. Cornell (1933). None of it is in Manilius or in Ptolemy:',
    'zodiacBody.modern.glands':
...
const GROUNDING_I18N = {
  pt: {
    ...
    'grounding.today.week':
      'A atribuição dos dias da semana aos sete planetas está documentada desde a Antiguidade, com origem atribuída ao Egito: contando as horas do dia e da noite pela ordem dos astros, cada dia recebe o nome do que rege a sua primeira hora.',
    ...
    'grounding.terra.triplicity':
      'A astrologia agrupa Touro, Virgem e Capricórnio na triplicidade correspondente à terra. Em Ptolomeu ela é atribuída ao domínio de Vênus, que rege de dia, e da Lua, que rege de noite; o capítulo a descreve como meridional e registra uma mistura vinda do leste por meio de Saturno, porque Capricórnio é domicílio dele.',
    'grounding.terra.divergence':
      'Os regentes de triplicidade divergem entre as autoridades antigas, e isso é conhecido: Doroteu de Sidon e Vétio Valente preservam um esquema mais antigo de três — diurno, noturno e participante — em que a terra fica com Vênus, a Lua e Marte. Citar um regente sem dizer de quem é o esquema esconde essa divergência.',
  ...
  es: {
    ...
    'grounding.today.week':
      'La atribución de los días de la semana a los siete planetas está documentada desde la Antigüedad, con origen atribuido a Egipto: contando las horas del día y de la noche por el orden de los astros, cada día recibe el nombre del que rige su primera hora.',
    'grounding.today.unavailable':
    ...
    'grounding.terra.triplicity':
      'La astrología agrupa a Tauro, Virgo y Capricornio en la triplicidad correspondiente a la tierra. En Ptolomeo se atribuye al dominio de Venus, que rige de día, y de la Luna, que rige de noche; el capítulo la describe como meridional y registra una mezcla venida del este por medio de Saturno, porque Capricornio es su domicilio.',
    'grounding.terra.divergence':
      'Los regentes de triplicidad divergen entre las autoridades antiguas, y eso se sabe: Doroteo de Sidón y Vetio Valente conservan un esquema más antiguo de tres — diurno, nocturno y participante — en el que la tierra queda con Venus, la Luna y Marte. Citar un regente sin decir de quién es el esquema esconde esa divergencia.',
    'grounding.terra.synthesis':
  ...
  en: {
    ...
    'grounding.today.week':
      'Assigning the days of the week to the seven planets is documented from antiquity, with the custom credited to Egypt: counting the hours of day and night in the order of the planets, each day takes the name of the one ruling its first hour.',
    'grounding.today.unavailable':
    ...
    'grounding.terra.triplicity':
      'Astrology groups Taurus, Virgo and Capricorn in the triplicity that corresponds to earth. In Ptolemy it is assigned to the dominion of Venus, ruling by day, and the Moon, ruling by night; the chapter describes it as southern and records a mixture from the east through Saturn, because Capricorn is his house.',
    'grounding.terra.divergence':
      'The rulers of the triplicities differ between the ancient authorities, and this is well known: Dorotheus of Sidon and Vettius Valens preserve an older scheme of three — diurnal, nocturnal and participating — in which earth gets Venus, the Moon and Mars. Quoting a ruler without saying whose scheme it is hides that disagreement.',
    'grounding.terra.synthesis':
...
const HOROSCOPE_SKY_I18N = {
  pt: {
    ...
    'horoscope.sky.change.dayRuler':
      'A Lua continua em {luaSigno} e o quarto lunar é o mesmo. O que mudou foi o dia e o regente dele, na ordem caldaica: {velho} → {novo}. É pouco — e esta tela prefere dizer que é pouco a inventar novidade.',
    ...
    'horoscope.sky.ruler.domicile':
      'Regente de {signo}: {planeta}. A tabela de domicílios não é arbitrária — Ptolomeu a deduz no Tetrabiblos I.17 da distância angular máxima de cada planeta ao Sol: Vênus nunca se afasta mais de dois signos, Mercúrio mais de um.',
    'horoscope.sky.ruler.position':
      'Posição de {planeta} neste dia: {signoPlaneta}. Calculada da efeméride, não sorteada.',
    ...
    'horoscope.sky.ruler.dignity.exaltacao':
      '{planeta} em {signoPlaneta} está na própria exaltação (Tetrabiblos I.19). Ptolomeu dá a exaltação por SIGNO e a explica pela marcha do Sol no ano; os graus famosos que circulam por aí não estão no Tetrabiblos, e por isso não aparecem aqui. O regente de {signo} está reforçado neste dia.',
    'horoscope.sky.ruler.dignity.exilio':
      '{planeta} em {signoPlaneta} está no signo oposto à própria casa — o que a tradição chamou de exílio. Ptolomeu nomeia a queda, não o exílio: esta é a leitura simétrica da mesma tabela de I.17, e vale como tradição, não como palavra dele. É a condição em que o regente de {signo} tem menos terreno de apoio.',
    'horoscope.sky.ruler.dignity.queda':
      '{planeta} em {signoPlaneta} está em queda: Ptolomeu nomeia essa condição no Tetrabiblos I.19, e ela é sempre o signo oposto ao da exaltação. Um regente de {signo} sem terreno de apoio é o que isso descreve — e descrever não é decretar desfecho.',
    'horoscope.sky.ruler.dignity.peregrino':
      '{planeta} em {signoPlaneta} não está em domicílio, exaltação, exílio nem queda: pelas tabelas de Tetrabiblos I.17 e I.19 o planeta está peregrino, sem terreno próprio e sem terreno hostil. É a condição mais comum dos planetas, e a mais honesta de admitir — neste dia o regente de {signo} não tem nada de excepcional a dizer.',
    'horoscope.sky.ruler.retrograde':
      '{planeta} está em movimento retrógrado aparente nesta data. Valens, na seção de trânsitos das Anthologiae: passada a primeira estação os planetas "atrasam expectativas, ações, lucros e empreendimentos"; passada a segunda, "cancelam o atraso e reinstauram as mesmas atividades". Atraso — e com prazo.',
    ...
    'horoscope.sky.moon.rel.copresenca':
      'É o seu próprio signo. Ptolomeu não chama isso de aspecto: no Tetrabiblos I.24 dois corpos no mesmo lugar são "aplicação corporal", categoria à parte, e no I.16 signos coincidentes ficam de fora dos quatro aspectos. Hoje a Lua não olha para {signo} — ela está dentro dele.',
    'horoscope.sky.moon.rel.alheio30':
      '{signoLua} é vizinho de {signo} na roda, e essa é justamente a relação que Ptolomeu chama de disjunta e alheia (Tetrabiblos I.16): os dois signos não se veem, "sem nenhuma participação nos quatro aspectos". Hoje a Lua não conversa com o seu signo. Isso é informação — e é exatamente o dia em que um horóscopo genérico inventaria alguma coisa.',
    'horoscope.sky.moon.rel.sextil':
      'De {signo} a {signoLua} vão dois signos: sextil. Ptolomeu o classifica como harmônico (Tetrabiblos I.13) porque une signos do mesmo gênero, e justifica a lista dos quatro aspectos por proporção musical.',
    'horoscope.sky.moon.rel.quadratura':
      'De {signo} a {signoLua} vão três signos: quadratura. Ptolomeu a classifica como desarmônica (Tetrabiblos I.13) — une signos de gêneros opostos. Tensão descrita, não sentença: no Tetrabiblos IV.5 ele registra que aspecto duro não encerra uma relação.',
    'horoscope.sky.moon.rel.trigono':
      'De {signo} a {signoLua} vão quatro signos: trígono. É o harmônico por excelência em Ptolomeu (Tetrabiblos I.13), unindo signos do mesmo gênero — e, na justificativa musical dele, é o terço da oposição.',
    'horoscope.sky.moon.rel.alheio150':
      'Entre {signo} e {signoLua} vão cinco signos, e isso não é aspecto: o Tetrabiblos I.16 põe esse intervalo entre os disjuntos e alheios. O mercado chama de quincunce e trata como aspecto — usar quincunce é inverter Ptolomeu, não continuá-lo, e por isso esta tela não usa.',
    'horoscope.sky.moon.rel.oposicao':
      'De {signo} a {signoLua} vão seis signos: oposição, o eixo inteiro da roda. Ptolomeu a classifica como desarmônica (Tetrabiblos I.13). É o dia em que a Lua está exatamente do outro lado do seu signo — e, de novo, ele descreve tensão, não decreta desfecho.',
    ...
    'horoscope.sky.moon.dignity.exaltacao':
      'E {signoLua} é a exaltação da Lua. A razão que Ptolomeu dá (Tetrabiblos I.19) é observável: depois da conjunção com o Sol no signo da exaltação solar, a Lua "mostra a primeira fase e começa a aumentar a sua luz" no primeiro signo do próprio triângulo. Por signo, não por grau — o grau de exaltação lunar que circula por aí vem de tabela helenística posterior, não do Tetrabiblos.',
    ...
    'horoscope.sky.quarter.practice.crescente':
      'Com a Lua crescendo, a agricultura romana punha o que devia CRESCER: Paládio (Opus Agriculturae I.6.12) manda semear tudo com a lua crescente, e Catão (De Agri Cultura 40.1) planta figueira, oliveira e videira com a lua escura, à tarde. Trocar a muda pela intenção é leitura do século XXI e fica declarada como nossa — o gesto agrícola é que tem dois mil anos.',
    'horoscope.sky.quarter.practice.minguante':
      'Com a Lua minguando, a agricultura romana punha o que devia ser CORTADO ou GUARDADO: Plínio (Naturalis Historia XVIII.321) registra que tudo que se corta, se colhe e se tosquia sofre menos dano com a lua decrescente, e Columela (XII.16.1) colhe a uva para passa assim. Vale dizer o que quase todo app inverte: colher para guardar é minguante, não é Lua Cheia.',
    ...
    'horoscope.sky.day.chaldean':
      'Regente de {dia}: {planeta}. A ordem dos regentes dos dias é a caldaica, e Dião Cássio já a explica na História Romana 37.18-19 — é de onde vêm os nomes dos dias em quase toda língua europeia.',
    ...
    'horoscope.sky.retro.valens':
      'Mercúrio está em movimento retrógrado aparente nesta data — calculado comparando a longitude eclíptica dele dois dias antes e dois dias depois, não consultado numa lista pronta. Valens: passada a primeira estação os planetas "atrasam expectativas, ações, lucros e empreendimentos"; passada a segunda, "cancelam o atraso e reinstauram as mesmas atividades".',
  ...
  es: {
    ...
    'horoscope.sky.change.dayRuler':
      'La Luna sigue en {luaSigno} y el cuarto lunar es el mismo. Lo que cambió fue el día y su regente, en el orden caldeo: {velho} → {novo}. Es poco — y esta pantalla prefiere decir que es poco antes que inventar una novedad.',
    ...
    'horoscope.sky.ruler.domicile':
      'Regente de {signo}: {planeta}. La tabla de domicilios no es arbitraria — Ptolomeo la deduce en el Tetrabiblos I.17 de la distancia angular máxima de cada planeta al Sol: Venus nunca se aleja más de dos signos, Mercurio más de uno.',
    'horoscope.sky.ruler.position':
      'Posición de {planeta} en este día: {signoPlaneta}. Calculada de la efeméride, no sorteada.',
    'horoscope.sky.ruler.dignity.domicilio':
    ...
    'horoscope.sky.ruler.dignity.exaltacao':
      '{planeta} en {signoPlaneta} está en su propia exaltación (Tetrabiblos I.19). Ptolomeo da la exaltación por SIGNO y la explica por la marcha del Sol en el año; los grados famosos que circulan por ahí no están en el Tetrabiblos, y por eso no aparecen aquí. El regente de {signo} está reforzado en este día.',
    'horoscope.sky.ruler.dignity.exilio':
      '{planeta} en {signoPlaneta} está en el signo opuesto a su propia casa — lo que la tradición llamó exilio. Ptolomeo nombra la caída, no el exilio: esta es la lectura simétrica de la misma tabla de I.17, y vale como tradición, no como palabra suya. Es la condición en que el regente de {signo} tiene menos terreno de apoyo.',
    'horoscope.sky.ruler.dignity.queda':
      '{planeta} en {signoPlaneta} está en caída: Ptolomeo nombra esa condición en el Tetrabiblos I.19, y es siempre el signo opuesto al de la exaltación. Un regente de {signo} sin terreno de apoyo es lo que eso describe — y describir no es decretar un desenlace.',
    'horoscope.sky.ruler.dignity.peregrino':
      '{planeta} en {signoPlaneta} no está en domicilio, exaltación, exilio ni caída: por las tablas del Tetrabiblos I.17 y I.19 el planeta está peregrino, sin terreno propio y sin terreno hostil. Es la condición más común de los planetas, y la más honesta de admitir — en este día el regente de {signo} no tiene nada excepcional que decir.',
    'horoscope.sky.ruler.retrograde':
      '{planeta} está en movimiento retrógrado aparente en esta fecha. Valens, en la sección de tránsitos de las Anthologiae: pasada la primera estación los planetas "retrasan expectativas, acciones, ganancias y empresas"; pasada la segunda, "cancelan el retraso y restablecen las mismas actividades". Retraso — y con plazo.',
    'horoscope.sky.ruler.valens':
    ...
    'horoscope.sky.moon.rel.copresenca':
      'Es tu propio signo. Ptolomeo no llama a esto aspecto: en el Tetrabiblos I.24 dos cuerpos en el mismo lugar son "aplicación corporal", categoría aparte, y en I.16 los signos coincidentes quedan fuera de los cuatro aspectos. Hoy la Luna no mira a {signo} — está dentro de él.',
    'horoscope.sky.moon.rel.alheio30':
      '{signoLua} es vecino de {signo} en la rueda, y esa es justamente la relación que Ptolomeo llama disjunta y ajena (Tetrabiblos I.16): los dos signos no se ven, "sin ninguna participación en los cuatro aspectos". Hoy la Luna no conversa con tu signo. Eso es información — y es exactamente el día en que un horóscopo genérico inventaría algo.',
    'horoscope.sky.moon.rel.sextil':
      'De {signo} a {signoLua} van dos signos: sextil. Ptolomeo lo clasifica como armónico (Tetrabiblos I.13) porque une signos del mismo género, y justifica la lista de los cuatro aspectos por proporción musical.',
    'horoscope.sky.moon.rel.quadratura':
      'De {signo} a {signoLua} van tres signos: cuadratura. Ptolomeo la clasifica como disarmónica (Tetrabiblos I.13) — une signos de géneros opuestos. Tensión descrita, no sentencia: en el Tetrabiblos IV.5 él registra que un aspecto duro no termina una relación.',
    'horoscope.sky.moon.rel.trigono':
      'De {signo} a {signoLua} van cuatro signos: trígono. Es el armónico por excelencia en Ptolomeo (Tetrabiblos I.13), uniendo signos del mismo género — y, en su justificación musical, es el tercio de la oposición.',
    'horoscope.sky.moon.rel.alheio150':
      'Entre {signo} y {signoLua} van cinco signos, y eso no es un aspecto: el Tetrabiblos I.16 pone ese intervalo entre los disjuntos y ajenos. El mercado lo llama quincuncio y lo trata como aspecto — usar el quincuncio es invertir a Ptolomeo, no continuarlo, y por eso esta pantalla no lo usa.',
    'horoscope.sky.moon.rel.oposicao':
      'De {signo} a {signoLua} van seis signos: oposición, el eje entero de la rueda. Ptolomeo la clasifica como disarmónica (Tetrabiblos I.13). Es el día en que la Luna está exactamente del otro lado de tu signo — y, de nuevo, él describe tensión, no decreta desenlace.',
    'horoscope.sky.moon.dignity.domicilio':
    ...
    'horoscope.sky.quarter.practice.crescente':
      'Con la Luna creciendo, la agricultura romana ponía lo que debía CRECER: Paladio (Opus Agriculturae I.6.12) manda sembrar todo con la luna creciente, y Catón (De Agri Cultura 40.1) planta higuera, olivo y vid con la luna oscura, por la tarde. Cambiar el plantón por la intención es lectura del siglo XXI y queda declarada como nuestra — el gesto agrícola es el que tiene dos mil años.',
    'horoscope.sky.quarter.practice.minguante':
      'Con la Luna menguando, la agricultura romana ponía lo que debía ser CORTADO o GUARDADO: Plinio (Naturalis Historia XVIII.321) registra que todo lo que se corta, se cosecha y se esquila sufre menos daño con la luna decreciente, y Columela (XII.16.1) cosecha así la uva para pasa. Vale decir lo que casi toda app invierte: cosechar para guardar es menguante, no es Luna Llena.',
    'horoscope.sky.quarter.eightNames':
    ...
    'horoscope.sky.day.chaldean':
      'Regente de {dia}: {planeta}. El orden de los regentes de los días es el caldeo, y Dión Casio ya lo explica en la Historia Romana 37.18-19 — de ahí vienen los nombres de los días en casi toda lengua europea.',
    'horoscope.sky.day.transposition':
    ...
    'horoscope.sky.retro.valens':
      'Mercurio está en movimiento retrógrado aparente en esta fecha — calculado comparando su longitud eclíptica dos días antes y dos días después, no consultado en una lista hecha. Valens: pasada la primera estación los planetas "retrasan expectativas, acciones, ganancias y empresas"; pasada la segunda, "cancelan el retraso y restablecen las mismas actividades".',
    'horoscope.sky.retro.folklore':
  ...
  en: {
    ...
    'horoscope.sky.change.dayRuler':
      'The Moon is still in {luaSigno} and the lunar quarter is the same. What changed is the day and its ruler, in the Chaldean order: {velho} → {novo}. That is little — and this screen would rather say it is little than invent news.',
    ...
    'horoscope.sky.ruler.domicile':
      'Ruler of {signo}: {planeta}. The table of domiciles is not arbitrary — Ptolemy derives it in Tetrabiblos I.17 from the maximum angular distance of each planet from the Sun: Venus is never more than two signs away, Mercury never more than one.',
    'horoscope.sky.ruler.position':
      'Position of {planeta} on this day: {signoPlaneta}. Computed from the ephemeris, not drawn at random.',
    'horoscope.sky.ruler.dignity.domicilio':
    ...
    'horoscope.sky.ruler.dignity.exaltacao':
      '{planeta} in {signoPlaneta} stands in its own exaltation (Tetrabiblos I.19). Ptolemy gives exaltation by SIGN and explains it by the yearly course of the Sun; the famous degrees that circulate everywhere are not in the Tetrabiblos, and so they do not appear here. The ruler of {signo} is reinforced on this day.',
    'horoscope.sky.ruler.dignity.exilio':
      '{planeta} in {signoPlaneta} stands in the sign opposite its own house — what the tradition called detriment. Ptolemy names the fall, not the detriment: this is the symmetrical reading of the same table in I.17, and it stands as tradition, not as his word. It is the condition in which the ruler of {signo} has the least supporting ground.',
    'horoscope.sky.ruler.dignity.queda':
      '{planeta} in {signoPlaneta} stands in fall: Ptolemy names this condition in Tetrabiblos I.19, and it is always the sign opposite the exaltation. A ruler of {signo} without supporting ground is what that describes — and describing is not decreeing an outcome.',
    'horoscope.sky.ruler.dignity.peregrino':
      '{planeta} in {signoPlaneta} is in neither domicile, exaltation, detriment nor fall: by the tables of Tetrabiblos I.17 and I.19 the planet is peregrine, with no ground of its own and no hostile ground either. It is the commonest condition for a planet, and the most honest one to admit — on this day the ruler of {signo} has nothing exceptional to say.',
    'horoscope.sky.ruler.retrograde':
      '{planeta} is in apparent retrograde motion on this date. Valens, in the transits section of the Anthologiae: past the first station the stars "delay expectations, actions, profits, and enterprises"; past the second, they "cancel any delay and reinstate the same activities". Delay — and with an end date.',
    'horoscope.sky.ruler.valens':
    ...
    'horoscope.sky.moon.rel.copresenca':
      'It is your own sign. Ptolemy does not call this an aspect: in Tetrabiblos I.24 two bodies in the same place are "bodily application", a separate category, and in I.16 coinciding signs are left out of the four aspects. Today the Moon is not looking at {signo} — it is inside it.',
    'horoscope.sky.moon.rel.alheio30':
      '{signoLua} is next to {signo} on the wheel, and that is precisely the relation Ptolemy calls disjunct and alien (Tetrabiblos I.16): the two signs do not see each other, "entirely without share in the four aforesaid aspects". Today the Moon does not speak to your sign. That is information — and it is exactly the day on which a generic horoscope would invent something.',
    'horoscope.sky.moon.rel.sextil':
      'From {signo} to {signoLua} is two signs: a sextile. Ptolemy classes it as harmonious (Tetrabiblos I.13) because it joins signs of the same gender, and he justifies the list of four aspects by musical proportion.',
    'horoscope.sky.moon.rel.quadratura':
      'From {signo} to {signoLua} is three signs: a square. Ptolemy classes it as disharmonious (Tetrabiblos I.13) — it joins signs of opposite gender. Tension described, not sentence passed: in Tetrabiblos IV.5 he records that a hard aspect does not end a relationship.',
    'horoscope.sky.moon.rel.trigono':
      'From {signo} to {signoLua} is four signs: a trine. It is the harmonious aspect par excellence in Ptolemy (Tetrabiblos I.13), joining signs of the same gender — and, in his musical justification, it is a third of the opposition.',
    'horoscope.sky.moon.rel.alheio150':
      'Between {signo} and {signoLua} lie five signs, and that is not an aspect: Tetrabiblos I.16 places that interval among the disjunct and alien ones. The market calls it a quincunx and treats it as an aspect — using the quincunx inverts Ptolemy rather than continuing him, and so this screen does not use it.',
    'horoscope.sky.moon.rel.oposicao':
      'From {signo} to {signoLua} is six signs: opposition, the whole axis of the wheel. Ptolemy classes it as disharmonious (Tetrabiblos I.13). It is the day the Moon stands exactly across from your sign — and again, he describes tension, he does not decree an outcome.',
    'horoscope.sky.moon.dignity.domicilio':
    ...
    'horoscope.sky.moon.dignity.exaltacao':
      'And {signoLua} is the exaltation of the Moon. Ptolemy\'s reason (Tetrabiblos I.19) is observable: after conjunction with the Sun in the sign of the solar exaltation, the Moon "shows her first phase and begins to increase her light" in the first sign of her own triangle. By sign, not by degree — the lunar exaltation degree that circulates everywhere comes from a later Hellenistic table, not from the Tetrabiblos.',
    'horoscope.sky.moon.dignity.exilio':
    ...
    'horoscope.sky.quarter.practice.crescente':
      'With the Moon waxing, Roman agriculture put in whatever was meant to GROW: Palladius (Opus Agriculturae I.6.12) orders everything to be sown with the moon waxing, and Cato (De Agri Cultura 40.1) plants fig, olive and vine by the dark moon, in the afternoon. Swapping the seedling for the intention is a 21st-century reading and is declared here as ours — it is the farming gesture that is two thousand years old.',
    'horoscope.sky.quarter.practice.minguante':
      'With the Moon waning, Roman agriculture put in whatever was to be CUT or STORED: Pliny (Naturalis Historia XVIII.321) records that everything cut, harvested or shorn suffers less harm with the moon waning, and Columella (XII.16.1) harvests grapes for raisins that way. Worth saying what almost every app gets backwards: harvesting for storage is waning, not Full Moon.',
    'horoscope.sky.quarter.eightNames':
    ...
    'horoscope.sky.day.chaldean':
      'Ruler of {dia}: {planeta}. The order of the rulers of the days is the Chaldean one, and Cassius Dio already explains it in Roman History 37.18-19 — it is where the names of the days come from in almost every European language.',
    'horoscope.sky.day.transposition':
    ...
    'horoscope.sky.retro.valens':
      'Mercury is in apparent retrograde motion on this date — computed by comparing its ecliptic longitude two days before and two days after, not looked up in a ready-made list. Valens: past the first station the stars "delay expectations, actions, profits, and enterprises"; past the second, they "cancel any delay and reinstate the same activities".',
    'horoscope.sky.retro.folklore':
