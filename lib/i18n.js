...
const ZODIAC_BODY_I18N = {
  pt: {
    ...
    'zodiacBody.sun.body': '{sign} aparece com: {part} — é onde o seu signo cai na lista antiga de Manílio.',
  ...
  es: {
    ...
    'zodiacBody.sun.body': '{sign} aparece con: {part} — es donde tu signo cae en la lista antigua de Manilio.',
    'zodiacBody.sun.caveat':
  ...
  en: {
    ...
    'zodiacBody.sun.body': '{sign} appears with: {part} — that is where your sign falls in Manilius’s old list.',
    'zodiacBody.sun.caveat':
...
const HOROSCOPE_SKY_I18N = {
  pt: {
    ...
    'horoscope.sky.change.dayRuler':
      'A Lua continua em {luaSigno} e o quarto lunar é o mesmo. O que mudou foi o dia — e o planeta que responde por ele, na ordem caldaica (a fila antiga dos sete planetas): {velho} → {novo}. É pouco — e esta tela prefere dizer que é pouco a inventar novidade.',
    ...
    'horoscope.sky.day.chaldean':
      'Cada dia da semana tem um planeta que responde por ele — e o de {dia} é {planeta}. É daí que vêm os nomes dos dias em quase toda língua europeia. A sequência é a ordem caldaica (a fila antiga dos sete planetas, herdada dos caldeus da Babilônia), e o recibo é romano: Dião Cássio já a explica na História Romana 37.18-19.',
  ...
  es: {
    ...
    'horoscope.sky.change.dayRuler':
      'La Luna sigue en {luaSigno} y el cuarto lunar es el mismo. Lo que cambió fue el día — y el planeta que responde por él, en el orden caldeo (la fila antigua de los siete planetas): {velho} → {novo}. Es poco — y esta pantalla prefiere decir que es poco antes que inventar una novedad.',
    ...
    'horoscope.sky.day.chaldean':
      'Cada día de la semana tiene un planeta que responde por él — y el de {dia} es {planeta}. De ahí vienen los nombres de los días en casi toda lengua europea. La secuencia es el orden caldeo (la fila antigua de los siete planetas, heredada de los caldeos de Babilonia), y el recibo es romano: Dión Casio ya lo explica en la Historia Romana 37.18-19.',
    'horoscope.sky.day.transposition':
  ...
  en: {
    ...
    'horoscope.sky.change.dayRuler':
      'The Moon is still in {luaSigno} and the lunar quarter is the same. What changed is the day — and the planet that answers for it, in the Chaldean order (the ancient queue of the seven planets): {velho} → {novo}. That is little — and this screen would rather say it is little than invent news.',
    ...
    'horoscope.sky.day.chaldean':
      'Every day of the week has a planet that answers for it — and the one for {dia} is {planeta}. That is where the names of the days come from in almost every European language. The sequence is the Chaldean order (the ancient queue of the seven planets, inherited from the Chaldeans of Babylon), and the receipt is Roman: Cassius Dio already explains it in Roman History 37.18-19.',
    'horoscope.sky.day.transposition':
