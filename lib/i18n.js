...
const ZODIAC_BODY_I18N = {
  pt: {
    ...
    'zodiacBody.sign.peixes.note':
      'Fecha a sequência, da cabeça aos pés. Em Astronomica IV.699-702 Manílio reusa a mesma figura como analogia para os PAÍSES regidos por cada signo: é citação cruzada, não uma segunda lista do corpo.',
    ...
    'zodiacBody.modern.intro':
      'Muita coisa que hoje se apresenta como «tradição antiga» tem cerca de cem anos e entrou pela literatura teosófica e rosacruz do século XX — Alan Leo (1917-18), Max e Augusta Foss Heindel (1929), H. L. Cornell (1933). Nada disto está em Manílio nem em Ptolomeu:',
  ...
  es: {
    ...
    'zodiacBody.sign.peixes.note':
      'Cierra la secuencia, de la cabeza a los pies. En Astronomica IV.699-702 Manilio reutiliza la misma figura como analogía para los PAÍSES regidos por cada signo: es una cita cruzada, no una segunda lista del cuerpo.',
    ...
    'zodiacBody.history.rule.body':
      'El precepto central no viene de Ptolomeo, y este es el punto en el que más se falla. Es el aforismo 20 del Centiloquium, colección de cien aforismos atribuida a Ptolomeo durante toda la Edad Media y la Edad Moderna, pero pseudoepigráfica: Richard Lemay argumentó que la obra es de Abu Ĝaʿfar Ibn Yusuf, astrólogo árabe del siglo X — tesis suya, no consenso cerrado —, y la primera traducción latina completa es de Barcelona, 1136. Los aforismos vecinos formaban todo un bloque de reglas de calendario terapéutico.',
    ...
    'zodiacBody.modern.intro':
      'Mucho de lo que hoy se presenta como «tradición antigua» tiene unos cien años y entró por la literatura teosófica y rosacruz del siglo XX: Alan Leo (1917-18), Max y Augusta Foss Heindel (1929), H. L. Cornell (1933). Nada de esto está en Manilio ni en Ptolomeo:',
    'zodiacBody.modern.glands':
  ...
  en: {
    ...
    'zodiacBody.sign.peixes.note':
      'It closes the sequence, head to feet. In Astronomica IV.699-702 Manilius reuses the same figure as an analogy for the COUNTRIES ruled by each sign: a cross-reference, not a second list of the body.',
    ...
    'zodiacBody.modern.intro':
      'A great deal of what is presented today as «ancient tradition» is about a hundred years old and came in through the theosophical and Rosicrucian literature of the 20th century: Alan Leo (1917-18), Max and Augusta Foss Heindel (1929), H. L. Cornell (1933). None of it is in Manilius or in Ptolemy:',
    'zodiacBody.modern.glands':
