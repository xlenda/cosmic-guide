...
const COSMIC_MEMORY_PRIVACY_I18N = {
  pt: {
    ...
    'privacy.ai.memory': 'Memória Cósmica opcional: cópias curtas de novas mensagens que você mesma escreveu ao Órbi, visíveis e apagáveis no Perfil',
  ...
  es: {
    ...
    'privacy.ai.memory': 'Memoria Cósmica opcional: copias breves de mensajes nuevos que tú escribiste a Órbi, visibles y eliminables desde el Perfil',
    ...
    'privacy.use.memory': 'Memoria Cósmica. Comienza desactivada. Cuando la activas en Perfil, nuestro servidor puede guardar hasta 60 copias breves de mensajes nuevos que tú escribas a Órbi. Hasta cuatro recuerdos relevantes pueden acompañar una pregunta futura enviada a Anthropic. No guardamos en esta memoria respuestas de la IA, el Diario, datos natales, la Comunidad ni el contexto de pareja. Puedes ver y borrar cada elemento, borrarlos todos o desactivar el uso en cualquier momento. Desactivarla detiene la recopilación y recuperación; eliminar la cuenta borra el contenido y el consentimiento.',
  ...
  en: {
    ...
    'privacy.ai.memory': 'Optional Cosmic Memory: short copies of new messages you wrote to Órbi, visible and deletable from Profile',
    ...
    'privacy.use.memory': 'Cosmic Memory. It starts disabled. When you enable it in Profile, our server may keep up to 60 short copies of new messages you write to Órbi. Up to four relevant memories may accompany a future question sent to Anthropic. This memory does not store AI responses, your Diary, birth data, Community content, or couple context. You can view and delete each item, delete everything, or disable use at any time. Disabling stops collection and retrieval; deleting the account removes both content and consent.',
