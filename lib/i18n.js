...
const FUNIL_3S_I18N = {
  pt: {
    ...
    'home.firstPath.title': 'Comece por {feature}',
    'home.firstPath.body': 'Você escolheu “{intent}”. Esta é a primeira etapa do caminho que o app montou com essa resposta.',
    'home.firstPath.cta': 'Abrir minha primeira etapa',
  ...
  es: {
    ...
    'home.firstPath.title': 'Empieza por {feature}',
    'home.firstPath.body': 'Elegiste “{intent}”. Esta es la primera etapa del camino que la app armó con esa respuesta.',
    'home.firstPath.cta': 'Abrir mi primera etapa',
  ...
  en: {
    ...
    'home.firstPath.title': 'Start with {feature}',
    'home.firstPath.body': 'You chose “{intent}”. This is the first step in the path the app built from that answer.',
    'home.firstPath.cta': 'Open my first step',
...
const PLAY_STORE_I18N = {
  pt: {
    ...
    'privacy.local.intent': 'O tema que você escolheu para ordenar o primeiro caminho',
  ...
  es: {
    ...
    'privacy.local.intent': 'El tema que elegiste para ordenar tu primer camino',
  ...
  en: {
    ...
    'privacy.local.intent': 'The theme you chose to order your first path',
