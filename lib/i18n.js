...
const ONBOARDING_I18N = {
  ...
  es: {
    ...
    'onboarding.intro.name': 'Soy Orbi.',
  ...
  en: {
    ...
    'onboarding.intro.name': 'I’m Orbi.',
...
const TAROT_LOTE_2_I18N = {
  pt: {
    ...
    'tarot.personal.disclaimer': 'A pergunta organiza a leitura; ela não transforma possibilidade em certeza nem muda o significado das cartas.',
  ...
  es: {
    ...
    'tarot.personal.disclaimer': 'La pregunta organiza la lectura; no convierte una posibilidad en certeza ni cambia el significado de las cartas.',
  ...
  en: {
    ...
    'tarot.personal.disclaimer': 'The question organizes the reading; it does not turn possibility into certainty or change what the cards mean.',
