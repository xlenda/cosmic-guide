...
const PT = {
  ...
  'home.sectionExploreSubtitle': 'Sozinho ou em casal — tudo liberado pra você',
  ...
  'home.card.tarotAmor.subtitle': 'A Madre Maria te guia, um dia de cada vez',
  ...
  'home.diary.empty': 'Guarde aqui suas leituras',
...
const ES = {
  ...
  'home.sectionExploreSubtitle': 'Solo o en pareja — todo liberado para ti',
  ...
  'home.card.tarotAmor.subtitle': 'La Madre María te guía, un día a la vez',
  'home.identidade.sol': 'Sol',
  ...
  'home.diary.empty': 'Guarda aquí tus lecturas',
...
const EN = {
  ...
  'home.sectionExploreSubtitle': 'Alone or as a couple — everything unlocked for you',
  ...
  'home.card.tarotAmor.subtitle': 'Madre Maria guides you, one day at a time',
  ...
  'home.diary.empty': 'Keep your readings here',
...
const EXPLORE_ITEM_DESCRIPTIONS_I18N = {
  pt: {
    ...
    'explore.item.idadereal.description': 'Compare quando 30 ideias astrológicas surgiram e veja quais ainda não têm data confirmada nas fontes.',
  ...
  es: {
    ...
    'explore.item.idadereal.description': 'Compara cuándo surgieron 30 ideas astrológicas y descubre cuáles aún no tienen fecha confirmada en las fuentes.',
  ...
  en: {
    ...
    'explore.item.idadereal.description': 'Compare when 30 astrological ideas emerged and see which still lack a confirmed date in the sources.',
