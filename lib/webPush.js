...
export async function subscribeToWebPush(personalSign) {
  ...
  try {
    ...
    // Chrome recusa a Push API inteira em modo anônimo/incógnito (limitação
    // do próprio navegador, não dá pra contornar nem detectar de antemão) —
    // esse é o motivo mais comum de falha "silenciosa" nos testes.
