...
export function getSpreadPattern(cards) {
  ...
  if (repeatedRank && RANK_GRADES[repeatedRank]) {
    ...
    notes.push(`O mesmo grau — o número da carta — saiu ${qtd} vezes nesta tiragem. A leitura de conjunto pesa esse padrão mais que cada carta isolada — prática que se firmou no séc. XX. ${RANK_GRADES[repeatedRank]}`);
  }
