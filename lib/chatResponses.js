...
const REPLIES = {
  luna: {
    ...
    trabalho: [
      'Carreira costuma se conectar com a Casa 10 — a área do mapa que fala de vocação e reputação — e com Saturno. Me conta o que tá em jogo: uma decisão, uma mudança, uma estagnação?',
    ...
    futuro: [
      'A astrologia trabalha com ciclos e trânsitos — o movimento dos planetas de hoje conversando com o seu mapa. É uma linguagem simbólica que a humanidade usa há milênios pra pensar o tempo. Me conta o que você mais quer entender sobre a fase que vem por aí?',
      ...
      'Os símbolos ajudam a organizar o que você já sente que está por vir. Me conta o que te deixa mais curiosa(o) ou ansiosa(o).',
    ],
    generic: [
  ...
  arcano: {
    ...
    futuro: [
      'O tarot fala a língua dos arquétipos — aquelas figuras que todo mundo reconhece, tipo o sábio, a mãe, o viajante — e não das certezas. É assim há séculos. Posso puxar o simbolismo de uma carta pra te ajudar a pensar no que vem. O que você mais quer refletir sobre o futuro?',
