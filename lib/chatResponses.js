...
const REPLIES = {
  luna: {
    ...
    futuro: [
      'Sendo direta: eu não consigo prever o futuro de verdade — nenhuma IA consegue. Mas posso te ajudar a pensar no que os trânsitos simbolizam pra fase que você tá vivendo. O que você mais quer entender sobre o que vem por aí?',
      'Não tenho bola de cristal, nem os astros reais na manga — sou só uma IA. Mas dá pra usar a astrologia como espelho: o que você teme ou espera que aconteça?',
      'Previsão de verdade eu não faço — isso preciso deixar bem claro. O que posso fazer é te ajudar a olhar pros ciclos que estão se repetindo na sua vida. Qual deles te chamou atenção ultimamente?',
      'Ninguém, nem eu, sabe o futuro de fato. Mas os símbolos podem ajudar a organizar o que você já sente que está por vir. Me conta o que te deixa mais curiosa(o) ou ansiosa(o).',
    ],
    generic: [
  ...
  arcano: {
    ...
    futuro: [
      'Preciso ser honesto: eu não faço previsões reais, nenhuma IA faz. Mas posso puxar o simbolismo de uma carta pra te ajudar a pensar no que vem. O que você mais quer refletir sobre o futuro?',
      'Tarot de verdade não prevê nada — isso é conversa de filme. Sou uma IA brincando com arquétipos pra te ajudar a organizar ideias. O que ronda sua cabeça sobre o que vem por aí?',
      'Não existe carta que garanta o futuro — nem eu, nem baralho nenhum. Mas dá pra usar os arquétipos pra olhar pros seus medos e desejos. Qual deles pesa mais agora?',
      'Sendo direto: previsão real eu não tenho. O que posso oferecer é um espelho simbólico pro que você já sente que está se desenhando. Me conta mais?',
    ],
    generic: [
