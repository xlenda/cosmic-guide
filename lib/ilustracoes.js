...
// ARTE DAS TIRAGENS (11/09/2026) — chave = o id da tiragem em
// lib/tarotRitualGuide.js (TAROT_GUIDE_SPREAD_IDS), o mesmo que vira o
// testID `tarot-spread-<id>` no TarotScreen. 'past-present-future' é a
// leitura de CONTINUIDADE ("Origem · Agora · Possibilidade") e
// 'situation-tension-next-step' a de DECISÃO ("Situação · Tensão · Próximo
// passo"). Mesmo contrato dos mascotes: id desconhecido → null → o card da
// tiragem desenha só o texto, como sempre desenhou.
export const TIRAGENS = Object.freeze({
  'past-present-future': require('../assets/ilustracoes/tiragem-continuidade.jpg'),
  'situation-tension-next-step': require('../assets/ilustracoes/tiragem-decisao.jpg'),
});

export function tiragemArte(spreadId) {
  return Object.prototype.hasOwnProperty.call(TIRAGENS, spreadId) ? TIRAGENS[spreadId] : null;
}
