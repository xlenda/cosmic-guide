...
// Segunda metade da recuperação: o link do e-mail abre uma sessão com evento
// PASSWORD_RECOVERY, mas a senha só muda quando updateUser é chamado dentro
// dessa sessão. Sem esta função o app dizia "criar uma senha nova" e nunca
// oferecia o campo que cumpria a promessa.
export async function updatePasswordForCurrentUser(password) {
  if (typeof password !== 'string' || password.length < 6) {
    return { error: 'login.error.weakPassword' };
  }
