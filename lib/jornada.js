...
export const TRILHAS = [
  {
    ...
    dias: [
      ...
      },
      {
        ...
        leitura:
          'Na roça antiga a regra era uma só, e é a coisa que sua avó falava: o que devia crescer ia com a Lua crescendo; o que devia secar ou diminuir, com a minguante. Ela tem versão em latim escrita muito antes: omnia quae seruntur crescente luna — tudo que se semeia deve ser semeado com a lua crescendo. Uma regra só, aplicada ao ano inteiro da roça. Transpor isso da lavoura para a sua agenda é leitura nossa, de hoje — a fonte fala de semente, madeira e animal. ' +
...

  {
    ...
    dias: [
      ...
      },
      {
        ...
        leitura:
          'Compatibilidade em porcentagem não existe em fonte nenhuma — é invenção comercial, do mesmo lote do horóscopo de jornal. O que a tradição tem é melhor e mais duro. Ptolomeu descreve seis tipos de relação entre signos, e uma delas é a aversão: signos a um ou a cinco signos de distância, que simplesmente não se enxergam. São 24 pares, quase um terço da tabela. Nenhum app do mercado mostra isso, porque nota baixa não vende — e é justamente a parte que nenhum app mostra. ' +
...
export const MEDALHAS = [
  ...
  },
  {
    ...
    legenda: 'Três dias seguidos. O hábito pegou.',
  },
  {
    id: 'guardiaoDaEfemeride',
    marco: 5,
    nome: 'Guardião da Efeméride',
    legenda: 'Cinco dias, cinco recibos conferidos.',
  },
  {
    id: 'desbravadorDoCeu',
    marco: 7,
...
export const MEDALHAS_JORNADA = [
  {
    ...
    legenda: 'Duas trilhas fechadas, do primeiro ao último dia.',
  },
  {
    id: 'cartografoDoCeu',
