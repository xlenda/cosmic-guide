...
// teste por mutação em test/filtroDado.test.js — que passou a EXISTIR em
// 13/09/2026. Até então este comentário apontava pra um arquivo que nunca
// tinha sido escrito: a cobertura funcional estava em test/diagramacaoPecas,
// mas quem viesse conferir a guarda da lei pelo nome escrito aqui não achava
// nada e concluía que ela não tinha guarda. As duas mutações que o portão
// pega: zero deixar de contar como dado (o `if (!valor)` clássico) e a linha
// sem dado virar traço em vez de sumir — que é a fabricação em pessoa.
//
