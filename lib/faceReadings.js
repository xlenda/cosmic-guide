...
export function getMockFaceReading() {
  ...
  // isGeneric: a tela usa isso pra DIZER que a leitura e simbolica geral,
  // nao personalizada — fallback que nao se declara vira quebra de
  // confianca (relato real do testador, 29/07/2026: sonho sem agua
  // nenhuma recebeu 'Aguas que revelam emocoes').
