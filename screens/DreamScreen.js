...
// interpreta, a cena da tela (CENAS.sonho) respira no lugar do spinner seco.
...
// que está acontecendo, nunca promessa; o rodapé de sempre
// (dream.interpreting) segue embaixo, intocado, ao lado do indicador pequeno.
          ...
          {step === STEP.INTRO && (
            <View style={styles.section}>
              ...
              {isAnalyzing ? (
                <EsperaIlustrada
                  arte={CENAS.sonho}
                  frase={t('espera.dream')}
                  rodape={t('dream.interpreting')}
                />
              ) : (
                <TouchableOpacity
